    ...
    `}_getSectionsOrder(){return this._config.sections_order||[...X.GC]}_updateSectionsOrder(e){const t={...this._config,sections_order:e};this._config=t,this._fireConfigChanged(t)}_isSectionDisabled(e){switch(e){case"custom_cards":return 0===(this._config.custom_cards||[]).length;case"custom_sections":return 0===(this._config.custom_sections||[]).length;case"weather":return!1===this._config.show_weather;case"energy":return!1===this._config.show_energy;case"plants":return!0!==this._config.show_plants_section;case"agenda":return!0!==this._config.show_agenda_section;case"todos":return!0!==this._config.show_todos_section;case"persons":return!0!==this._config.show_persons_section;case"vacuums":return!0!==this._config.show_vacuums_section;case"maintenance":return!0!==this._config.show_maintenance_section;default:return!1}}_isSectionToggleable(e){return["weather","energy","plants","agenda","todos","persons","vacuums","maintenance"].includes(e)}_toggleSectionVisibility(e,t){"weather"===e?this._toggleChanged("show_weather",t,!0):"energy"===e?this._toggleChanged("show_energy",t,!0):"plants"===e?this._toggleChanged("show_plants_section",t,!1):"agenda"===e?this._toggleChanged("show_agenda_section",t,!1):"todos"===e?this._toggleChanged("show_todos_section",t,!1):"persons"===e?this._toggleChanged("show_persons_section",t,!1):"vacuums"===e?this._toggleChanged("show_vacuums_section",t,!1):"maintenance"===e&&this._toggleChanged("show_maintenance_section",t,!1)}_toggleHiddenHeading(e,t){const i=new Set(this._config.hidden_section_headings||[]);t?i.add(e):i.delete(e);const r={...this._config};0===i.size?delete r.hidden_section_headings:r.hidden_section_headings=[...i],this._config=r,this._fireConfigChanged(r)}_sectionVisibilityChanged(e,t,i){const r={...this._config},o={...r.section_visibility||{}},a={...o[e]||{entity:"",state:""}};a[t]=i.trim(),a.entity||a.state?o[e]=a:delete o[e],0===Object.keys(o).length?delete r.section_visibility:r.section_visibility=o,this._config=r,this._fireConfigChanged(r)}_renderSectionOrderPanel(){const e=this._getSectionsOrder(),t=!1!==this._config.energy_link_dashboard,i=!1!==this._config.show_energy,o=this._config.weather_presentation||"forecast_daily",a=!1!==this._config.show_energy_distribution_card,s=this._config.power_badge_entity||"",n=this._getEntitiesByDomains(["sensor","binary_sensor","number","input_number"]),c=new Set(this._config.hidden_section_headings||[]);return r.qy`
      <div class="section">
        ...
        <div class="section-order-list" id="section-order-list">
          ${e.map(e=>{const c=ue._sectionMeta.get(e);if(!c)return r.s6;const d=this._isSectionDisabled(e),l=this._isSectionToggleable(e);return r.qy`
              <div
...
${this._formatEntityList(this._config.todos_entities)}</textarea
        ...
        <details style="margin-top: 12px;">
          ...
          <div style="margin-left: 14px; margin-top: 6px;">
            ...
            ${e.map(e=>{const t=ue._sectionMeta.get(e);if(!t)return r.s6;const i=this._config.section_visibility?.[e];return r.qy`
                <div
      ...
      <div class="entity-group" data-group="stack_order">
        ...
        <div class="entity-list">
          ...
          <div class="section-order-list" data-area-id=${e}>
            ${a.map(t=>{const i=ue._stackMeta.get(t);return i?r.qy`
                <div
          ...
          ${s.length>0?r.qy`
                <div class="section-order-compact">
                  ...
                  <div class="compact-chip-list">
                    ${s.map(e=>{const t=ue._stackMeta.get(e);return t?r.qy`
    ...
    `}_renderBasicOverviewSection(){const e=this._config.theme||"",t=this._getThemeNames(),i=this._config.background||{},o=i.image,a="number"==typeof i.opacity?i.opacity:100,s=this._config.weather_entity||"",n=this._getWeatherEntities(),c=this._config.overview_max_columns??3,d=this._config.overview_area_card_columns??"full",l=this._config.weather_start_weather_mode??"full",h=this._config.weather_start_date_card??"button-card";return r.qy`
      <div class="section">
        ...
        <div class="form-row" style="display: block;">
          ${customElements.get("ha-form")?r.qy`<ha-form
                ...
                @value-changed=${e=>this._backgroundImageChanged(e.detail.value.image)}
              ></ha-form>`:r.qy`<label for="basic-dashboard-background">${(0,ee.k)("editor.background_image")}</label>
                <input id="basic-dashboard-background" type="text"
                  .value=${"string"==typeof o?o:""}
                  placeholder="/local/background.jpg"
                  @change=${e=>this._backgroundImageChanged(e.target.value.trim())} />`}
        ...
        ${o?r.qy`<div class="form-row">
              ...
              <input type="range" min="10" max="100" step="5" style="flex: 1;"
                .value=${String(a)}
                @change=${e=>this._backgroundOptionChanged("opacity",Number(e.target.value))} />
              <span>${a}%</span>
            </div>
            ${this._renderCheckbox("basic-dashboard-background-fixed",(0,ee.k)("editor.background_fixed"),"fixed"===i.attachment,e=>this._backgroundOptionChanged("attachment",e?"fixed":void 0))}`:r.s6}
        <div class="form-row">
          ...
          <select id="basic-weather-entity" style="flex: 1;" @change=${this._weatherEntityChanged}>
            <option value="" ?selected=${!s}>${(0,ee.k)("editor.weather_entity_auto")}</option>
            ${n.map(e=>r.qy`
                <option value=${e.entity_id} ?selected=${e.entity_id===s}>
                  ${e.name}
                </option>
        ...
        <div class="form-row">
          ...
          >
            ${[1,2,3,4].map(e=>r.qy`<option value=${e} ?selected=${c===e}>${e}</option>`)}
          </select>
        </div>
        <div class="form-row">
          ...
          >
            <option value="full" ?selected=${"full"===d}>${(0,ee.k)("editor.columns_full")}</option>
            <option value="6" ?selected=${6===d}>2</option>
            <option value="4" ?selected=${4===d}>3</option>
          </select>
        </div>
        <div class="form-row">
          ...
          >
            <option value="full" ?selected=${"full"===l}>${(0,ee.k)("editor.weather_mode_full")}</option>
            <option value="compact_hourly" ?selected=${"compact_hourly"===l}>
        ...
        <div class="form-row">
          ...
          >
            <option value="button-card" ?selected=${"button-card"===h}>button-card</option>
            <option value="markdown" ?selected=${"markdown"===h}>
  ...
  `;return r.qy`<div class="section">
    ...
    `}_renderCustomViewRefFields(e,t){if(null===this._refDashboards)return this._loadRefDashboards(),r.qy`<div class="description">${(0,ee.k)("editor.ref_loading")}</div>`;if(0===this._refDashboards.length)return r.qy`<div class="custom-item-validation" style="color: var(--error-color);">
            ...
            >
              ${["custom_cards","overview","areas","weather","energy"].map(t=>r.qy`
                  <option value=${t} ?selected=${(e.target_section||"custom_cards")===t}>
                    ${(0,ee.k)(ue._sectionMeta.get(t).labelKey)}
                  </option>
                `)}
            </select>
          </div>
    ...
    `}}function ge(e,t){return t.areas_options?.[e]?.groups_options?.badges?.additional||[]}function me(e,t){const i=new Set;for(const r of e){const e=t.states[r];if(!e)continue;const o=e.attributes?.device_class;(0,te.g7)(o)&&i.add(r)}return i}function fe(e,t){const i=t.areas_options?.[e]?.groups_options?.badges;return{namesVisible:i?.names_visible||[],namesHidden:i?.names_hidden||[]}}function ye(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.hidden&&(r[e]=t.hidden);return r}function ve(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.order&&(r[e]=t.order);return r}ue.properties={_config:{state:!0},_expandedAreas:{state:!0},_expandedGroups:{state:!0},_expandedWeatherBlocks:{state:!0},_cardPickerOpen:{state:!0},_cardPickerStep:{state:!0},_cardPickerSearch:{state:!0},_cardPickerSelectedType:{state:!0},_cardPickerYaml:{state:!0},_cardPickerHasVisualEditor:{state:!0}},ue.styles=[re,r.AH`
      /* -- Base layout --------------------------------------------------- */
      .card-config {
        padding: 16px;
