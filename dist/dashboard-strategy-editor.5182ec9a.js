      ...
      <div class="card-config">
        ...
        ${this._advancedExpanded?r.qy`
              <div class="advanced-content">
                ...
                ${ae(this,fe,()=>this._renderCustomContentSection())}
              </div>
            `:r.s6}
      </div>
