    ...
    `}_getSectionsOrder(){return this._config.sections_order||[...X.GC]}_updateSectionsOrder(e){const t={...this._config,sections_order:e};this._config=t,this._fireConfigChanged(t)}_isSectionDisabled(e){switch(e){case"custom_cards":return 0===(this._config.custom_cards||[]).length;case"custom_sections":return 0===(this._config.custom_sections||[]).length;case"weather":return!1===this._config.show_weather;case"energy":return!1===this._config.show_energy;case"plants":return!0!==this._config.show_plants_section;case"agenda":return!0!==this._config.show_agenda_section;case"todos":return!0!==this._config.show_todos_section;case"persons":return!0!==this._config.show_persons_section;case"vacuums":return!0!==this._config.show_vacuums_section;case"maintenance":return!0!==this._config.show_maintenance_section;default:return!1}}_isSectionToggleable(e){return["weather","energy","plants","agenda","todos","persons","vacuums","maintenance"].includes(e)}_toggleSectionVisibility(e,t){"weather"===e?this._toggleChanged("show_weather",t,!0):"energy"===e?this._toggleChanged("show_energy",t,!0):"plants"===e?this._toggleChanged("show_plants_section",t,!1):"agenda"===e?this._toggleChanged("show_agenda_section",t,!1):"todos"===e?this._toggleChanged("show_todos_section",t,!1):"persons"===e?this._toggleChanged("show_persons_section",t,!1):"vacuums"===e?this._toggleChanged("show_vacuums_section",t,!1):"maintenance"===e&&this._toggleChanged("show_maintenance_section",t,!1)}_toggleHiddenHeading(e,t){const i=new Set(this._config.hidden_section_headings||[]);t?i.add(e):i.delete(e);const r={...this._config};0===i.size?delete r.hidden_section_headings:r.hidden_section_headings=[...i],this._config=r,this._fireConfigChanged(r)}_sectionVisibilityChanged(e,t,i){const r={...this._config},o={...r.section_visibility||{}},a={...o[e]||{entity:"",state:""}};a[t]=i.trim(),a.entity||a.state?o[e]=a:delete o[e],0===Object.keys(o).length?delete r.section_visibility:r.section_visibility=o,this._config=r,this._fireConfigChanged(r)}_renderSectionOrderPanel(){const e=this._getSectionsOrder(),t=!1!==this._config.energy_link_dashboard,i=!1!==this._config.show_energy,o=this._config.weather_presentation||"forecast_daily",a=!1!==this._config.show_energy_distribution_card,s=this._config.power_badge_entity||"",n=this._getEntitiesByDomains(["sensor","binary_sensor","number","input_number"]),c=new Set(this._config.hidden_section_headings||[]);return r.qy`
      <div class="section">
        ...
        <div class="section-order-list" id="section-order-list">
          ${e.map(e=>{const c=_e._sectionMeta.get(e);if(!c)return r.s6;const d=this._isSectionDisabled(e),l=this._isSectionToggleable(e);return r.qy`
              <div
...
${this._formatEntityList(this._config.todos_entities)}</textarea
        ...
        <details style="margin-top: 12px;">
          ...
          <div style="margin-left: 14px; margin-top: 6px;">
            ...
            ${e.map(e=>{const t=_e._sectionMeta.get(e);if(!t)return r.s6;const i=this._config.section_visibility?.[e];return r.qy`
                <div
    ...
    `}_removeWeatherStartItem(e){const t=this._getWeatherStartLayoutItems(),i=t.find(t=>t.id===e),r=t.filter(t=>t.id!==e);if(i){if("custom_card"===i.type){const e=[...this._config.custom_cards||[]],t=this._getWeatherStartCustomCardIndex(i,e);t>=0&&e.splice(t,1);const o={...this._config,weather_start_layout_items:r};return e.length>0?o.custom_cards=e:delete o.custom_cards,this._config=o,void this._fireConfigChanged(o)}if("custom_section"===i.type){const e=[...this._config.custom_sections||[]],t=this._getWeatherStartCustomSectionIndex(i,e);t>=0&&e.splice(t,1);const o={...this._config,weather_start_layout_items:r};return e.length>0?o.custom_sections=e:delete o.custom_sections,this._config=o,void this._fireConfigChanged(o)}this._saveWeatherStartLayoutItems(r)}else this._saveWeatherStartLayoutItems(r)}_addWeatherStartSummaries(){const e=this._getWeatherStartLayoutItems();e.some(e=>"summaries"===e.type)||(e.push({id:this._createWeatherStartItemId("summaries"),type:"summaries",summary_size:"mini"}),this._saveWeatherStartLayoutItems(e),this._expandedWeatherBlocks=new Set([...this._expandedWeatherBlocks,e[e.length-1].id]))}_addWeatherStartArea(e){const t=e.target.value;if(!t)return;const i=this._getWeatherStartLayoutItems();i.push({id:this._createWeatherStartItemId(`area-${t}`),type:"area",area_id:t}),this._saveWeatherStartLayoutItems(i),e.target.value=""}_addWeatherStartFloor(e){const t=e.target.value;if(!t)return;const i="__none__"===t?null:t,r=this._getWeatherStartFloorOptions().find(e=>e.floor_id===i),o=this._getWeatherStartLayoutItems();o.push({id:this._createWeatherStartItemId(`floor-${i||"none"}`),type:"floor",floor_id:i,title:r?.name}),this._saveWeatherStartLayoutItems(o),e.target.value=""}_toggleWeatherStartItemStack(e,t){const i=this._getWeatherStartLayoutItems().map(i=>{if(i.id!==e)return i;const r={...i};return t?r.stack_with_previous=!0:delete r.stack_with_previous,r});this._saveWeatherStartLayoutItems(i)}_weatherStartSummarySizeChanged(e,t){const i=this._getWeatherStartLayoutItems().map(i=>i.id!==e?i:{...i,summary_size:t});this._saveWeatherStartLayoutItems(i)}_addWeatherStartSection(){const e=this._createWeatherStartItemId("section"),t=[...this._config.custom_sections||[],{id:e,title:"",icon:"",cards:[]}],i=[...this._getWeatherStartLayoutItems(),{id:`custom-section-${e}`,type:"custom_section",custom_section_id:e}],r={...this._config,custom_sections:t,weather_start_layout_items:i};this._config=r,this._fireConfigChanged(r),this._expandedWeatherBlocks=new Set([...this._expandedWeatherBlocks,`custom-section-${e}`])}_getWeatherStartItemMeta(e,t,i,r){if("area"===e.type){const i=t.find(t=>t.area_id===e.area_id);return{icon:i?.icon||"mdi:home-outline",label:i?.name||e.area_id||(0,ee.k)("sections.areas")}}if("floor"===e.type){const t=this._getWeatherStartFloorOptions().find(t=>t.floor_id===(e.floor_id??null));return{icon:t?.icon||"mdi:floor-plan",label:e.title||t?.name||(0,ee.k)("sections.areas")}}if("custom_card"===e.type){const t=i.find((t,i)=>this._getCustomCardRef(t,i)===e.custom_card_id);return{icon:"mdi:cards",label:this._getCustomCardEditorLabel(t,(0,ee.k)("editor.new_card"))}}if("custom_section"===e.type){const t=r.find((t,i)=>this._getCustomSectionRef(t,i)===e.custom_section_id);return{icon:t?.icon||"mdi:view-grid-plus-outline",label:t?.title||(0,ee.k)("editor.section_custom_sections")}}const o=_e._weatherStartBlockMeta.get(e.type);return{icon:o?.icon||"mdi:view-dashboard-outline",label:o?(0,ee.k)(o.labelKey):e.type}}_isWeatherStartItemDisabled(e,t,i){return!e.parsed_config&&(!!e._yaml_error||("custom_card"===e.type?!t.some((t,i)=>this._getCustomCardRef(t,i)===e.custom_card_id&&t.parsed_config):"custom_section"===e.type?!i.some((t,i)=>this._getCustomSectionRef(t,i)===e.custom_section_id&&(t.cards||[]).some(e=>e.parsed_config)):"floor"===e.type?!this._getWeatherStartAreaOptions().some(t=>e.floor_id?t.floor_id===e.floor_id:!t.floor_id):"summaries"===e.type?this._isWeatherStartBlockDisabled("summaries"):!!_e._weatherStartBlockMeta.has(e.type)&&this._isWeatherStartBlockDisabled(e.type)))}_countNestedFixedGrids(e,t=0){if(!e||"object"!=typeof e)return 0;if(Array.isArray(e))return e.reduce((e,i)=>e+this._countNestedFixedGrids(i,t),0);const i=e;return(t>0&&"grid"===i.type&&"number"==typeof i.columns?1:0)+Object.values(i).reduce((e,i)=>e+this._countNestedFixedGrids(i,t+1),0)}_renderWeatherStartOrderPanel(){const e=this._getWeatherStartLayoutItems(),t=this._getWeatherStartAreaOptions(),i=this._getWeatherStartFloorOptions(),o=this._config.custom_cards||[],a=this._config.custom_sections||[],s=e.some(e=>"summaries"===e.type),n=new Set(e.filter(e=>"area"===e.type&&e.area_id).map(e=>e.area_id));for(const i of e)if("floor"===i.type)for(const e of t)(i.floor_id?e.floor_id!==i.floor_id:e.floor_id)||n.add(e.area_id);const c=t.filter(e=>!n.has(e.area_id));let d=0;const l=e.some(e=>(d=e.stack_with_previous?d+1:0,d>=2));return r.qy`
      <div class="section">
        ...
        <div class="section-order-list" id="weather-start-order-list">
          ${e.map(e=>{const i=this._getWeatherStartItemMeta(e,t,o,a),s=this._isWeatherStartItemDisabled(e,o,a),n=this._expandedWeatherBlocks.has(e.id),c=!!e.yaml,d="area"!==e.type&&"floor"!==e.type,l=this._getWeatherStartCustomCardIndex(e,o),h=l>=0?o[l]:void 0,p=this._getWeatherStartCustomSectionIndex(e,a),_=p>=0?a[p]:void 0,u=this._countNestedFixedGrids(e.parsed_config);return r.qy`
              <div>
                <div
                  class="section-order-item ${s?"disabled":""}"
                  data-ws-id=${e.id}
                  draggable="true"
      ...
      <div class="entity-group" data-group="stack_order">
        ...
        <div class="entity-list">
          ...
          <div class="section-order-list" data-area-id=${e}>
            ${a.map(t=>{const i=_e._stackMeta.get(t);return i?r.qy`
                <div
          ...
          ${s.length>0?r.qy`
                <div class="section-order-compact">
                  ...
                  <div class="compact-chip-list">
                    ${s.map(e=>{const t=_e._stackMeta.get(e);return t?r.qy`
    ...
    `}_renderBasicOverviewSection(){const e=this._config.theme||"",t=this._getThemeNames(),i=this._config.weather_entity||"",o=this._getWeatherEntities(),a=this._config.overview_max_columns??3,s=this._config.overview_area_card_columns??"full",n=this._config.weather_start_weather_mode??"full",c=this._config.weather_start_date_card??"button-card";return r.qy`
      <div class="section">
        ...
        <div class="form-row">
          ...
          <select id="basic-dashboard-theme" style="flex: 1;" @change=${this._themeChanged}>
            ...
            ${t.map(t=>r.qy` <option value=${t} ?selected=${t===e}>${t}</option> `)}
          </select>
        </div>
        <div class="form-row">
          ...
          <select id="basic-weather-entity" style="flex: 1;" @change=${this._weatherEntityChanged}>
            <option value="" ?selected=${!i}>${(0,ee.k)("editor.weather_entity_auto")}</option>
            ${o.map(e=>r.qy`
        ...
        <div class="form-row">
          ...
          >
            ${[1,2,3,4].map(e=>r.qy`<option value=${e} ?selected=${a===e}>${e}</option>`)}
          </select>
        </div>
        <div class="form-row">
          ...
          >
            <option value="full" ?selected=${"full"===s}>${(0,ee.k)("editor.columns_full")}</option>
            <option value="6" ?selected=${6===s}>2</option>
            <option value="4" ?selected=${4===s}>3</option>
          </select>
        </div>
        <div class="form-row">
          ...
          >
            <option value="full" ?selected=${"full"===n}>${(0,ee.k)("editor.weather_mode_full")}</option>
            <option value="compact_hourly" ?selected=${"compact_hourly"===n}>
        ...
        <div class="form-row">
          ...
          >
            <option value="button-card" ?selected=${"button-card"===c}>button-card</option>
            <option value="markdown" ?selected=${"markdown"===c}>
    ...
    `}_renderAreasListSection(){const e=this._getSortedAreas(),t=this._getNormalizedAreasDisplay(),i=t?.hidden||[],o=t?.order||[],a=t?.nav_items||[];return r.qy`
      <div class="section">
        ...
        <div class="area-list" id="area-list">${this._renderAreaItems(e,i,o,a)}</div>
      </div>
    `}_renderOverviewSection(){const e=!1!==this._config.show_clock_card,t=!0===this._config.show_search_card,i=!1!==this._config.show_person_badges,a=this._config.person_badge_layout||"with_state",s=this._checkSearchCardDependencies(),n=this._config.alarm_entity||"",c=this._getAlarmEntities();return r.qy`
      <div class="section">
        ...
        ${r.qy`
          ...
          ${this._renderCheckbox("show-search-card",(0,ee.k)("editor.show_search_card"),t,e=>this._toggleChanged("show_search_card",e,!1),"tip"!==this._config.search_card_variant&&!s)}
          <div class="description">
            ${"tip"===this._config.search_card_variant||s?(0,ee.k)("editor.show_search_card_desc"):r.qy`<span>&#x26A0;&#xFE0F; ${(0,o._)((0,ee.k)("editor.show_search_card_missing"))}</span>`}
          </div>
          ${t?r.qy`
            <div class="form-row">
    ...
    `}_renderFavoritesSection(){const e=this._config.favorite_entities||[],t=this._getAllEntitiesForSelect(),i=!0===this._config.favorites_show_state,o=!0===this._config.favorites_hide_last_changed,a=new Map(t.map(e=>[e.entity_id,e.name])),s=this._getFilteredEntities(this._favoriteSearch),n=this._config.light_favorite_entities||[];return r.qy`
      <div class="section">
    ...
    `}_renderViewsSection(){const e=!0===this._config.show_summary_views,t=!0===this._config.show_room_views,i=!0===this._config.show_cctv_view,o=!0===this._config.cctv_show_activity,a=!0===this._config.show_maintenance_view;return r.qy`${function(e){const t=(t,i,o)=>r.qy`
  ...
  `;return r.qy`<div class="section">
  ...
  </div>`}({showSummaryViews:e,showRoomViews:t,showCctvView:i,cctvShowActivity:o,showMaintenanceView:a,checkbox:(e,t,i,r)=>this._renderCheckbox(e,t,i,r),change:(e,t)=>this._toggleChanged(e,t,!1)})}${s=this,s._hass?r.qy`<div class="section">
    ...
    ${s._getSortedAreas().map(e=>{const t=s._config.room_visibility?.[e.area_id];return r.qy`<div class="option-group">
        <div class="option-group-title">${e.name}</div>
        <div class="form-row">
          <ha-textfield label=${(0,ee.k)("editor.room_visibility_entity")} .value=${t?.entity||""}
            @change=${t=>oe(s,e.area_id,"entity",t.target.value)}></ha-textfield>
          <ha-textfield label=${(0,ee.k)("editor.room_visibility_state")} .value=${t?.state||""}
            @change=${t=>oe(s,e.area_id,"state",t.target.value)}></ha-textfield>
        </div>
      </div>`})}
  </div>`:r.qy``}${function(e){if(!e._hass)return r.qy``;const t=Object.entries(e._hass.states).filter(([e,t])=>e.startsWith("person.")&&"string"==typeof t.attributes.user_id).map(([e,t])=>({id:t.attributes.user_id,name:String(t.attributes.friendly_name||e)})).sort((e,t)=>e.name.localeCompare(t.name));if(0===t.length)return r.qy``;const i=[["home",(0,ee.k)("views.overview")],["lights",(0,ee.k)("views.lights")],["covers",(0,ee.k)("views.covers")],["security",(0,ee.k)("views.security")],["batteries",(0,ee.k)("views.batteries")],["climate",(0,ee.k)("views.climate")],["cctv",(0,ee.k)("views.cctv")],["maintenance",(0,ee.k)("views.maintenance")],...Object.values(e._hass.areas).map(e=>[e.area_id,e.name]),...(e._config.custom_views||[]).filter(e=>e.path&&e.title).map(e=>[e.path,e.title])],o=X.lg.map(e=>[e,(0,ee.k)(`weather_start_blocks.${e}`)]),a=(i,o)=>o.map(([o,a])=>{const s="view"===i?e._config.view_visible_users:e._config.section_visible_users,n=Object.prototype.hasOwnProperty.call(s||{},o)?s?.[o]||[]:t.map(e=>e.id);return r.qy`<div class="option-group"><div class="option-group-title">${a}</div>${t.map(r=>e._renderCheckbox(`${i}-${o}-${r.id}`,r.name,n.includes(r.id),a=>function(e,t,i,r,o,a){const s={...("view"===t?e._config.view_visible_users:e._config.section_visible_users)||{}},n=new Set(Object.prototype.hasOwnProperty.call(s,i)?s[i]:o);a?n.add(r):n.delete(r),o.every(e=>n.has(e))&&[...n].every(e=>o.includes(e))?delete s[i]:s[i]=[...n];const c={...e._config};"view"===t?Object.keys(s).length?c.view_visible_users=s:delete c.view_visible_users:Object.keys(s).length?c.section_visible_users=s:delete c.section_visible_users,e._fireConfigChanged(c)}(e,i,o,r.id,t.map(e=>e.id),a)))}</div>`});return r.qy`<div class="section"><div class="section-title">${(0,ee.k)("editor.user_visibility")}</div>
    <div class="description" style="margin-left: 0;">${(0,ee.k)("editor.user_visibility_warning")}</div>
    <div class="option-group-title">${(0,ee.k)("editor.user_visibility_views")}</div>${a("view",i)}
    <div class="option-group-title">${(0,ee.k)("editor.user_visibility_sections")}</div>${a("section",o)}
  </div>`}(this)}`;var s}_renderRoomVisibilityRules(){return this._hass?r.qy`<div class="section">
      <div class="section-title">${(0,ee.k)("editor.room_visibility")}</div>
      <div class="description" style="margin-left: 0;">${(0,ee.k)("editor.room_visibility_desc")}</div>
    ...
    </div>`:r.qy``}_roomVisibilityChanged(e,t,i){const r={...this._config.room_visibility||{}},o={entity:r[e]?.entity||"",state:r[e]?.state||"",[t]:i.trim()};o.entity||o.state?r[e]=o:delete r[e];const a={...this._config};Object.keys(r).length>0?a.room_visibility=r:delete a.room_visibility,this._fireConfigChanged(a)}_renderUserVisibilityRules(){if(!this._hass)return r.qy``;const e=Object.entries(this._hass.states).filter(([e,t])=>e.startsWith("person.")&&"string"==typeof t.attributes.user_id).map(([e,t])=>({id:t.attributes.user_id,name:String(t.attributes.friendly_name||e)})).sort((e,t)=>e.name.localeCompare(t.name));if(0===e.length)return r.qy``;const t=[["home",(0,ee.k)("views.overview")],["lights",(0,ee.k)("views.lights")],["covers",(0,ee.k)("views.covers")],["security",(0,ee.k)("views.security")],["batteries",(0,ee.k)("views.batteries")],["climate",(0,ee.k)("views.climate")],["cctv",(0,ee.k)("views.cctv")],["maintenance",(0,ee.k)("views.maintenance")],...Object.values(this._hass.areas).map(e=>[e.area_id,e.name]),...(this._config.custom_views||[]).filter(e=>e.path&&e.title).map(e=>[e.path,e.title])],i=X.lg.map(e=>[e,(0,ee.k)(`weather_start_blocks.${e}`)]),o=(t,i)=>i.map(([i,o])=>{const a="view"===t?this._config.view_visible_users:this._config.section_visible_users,s=Object.prototype.hasOwnProperty.call(a||{},i)?a?.[i]||[]:e.map(e=>e.id);return r.qy`<div class="option-group"><div class="option-group-title">${o}</div>${e.map(r=>this._renderCheckbox(`${t}-${i}-${r.id}`,r.name,s.includes(r.id),o=>this._userVisibilityChanged(t,i,r.id,e.map(e=>e.id),o)))}</div>`});return r.qy`<div class="section"><div class="section-title">${(0,ee.k)("editor.user_visibility")}</div>
      <div class="description" style="margin-left: 0;">${(0,ee.k)("editor.user_visibility_warning")}</div>
    ...
    </div>`}_userVisibilityChanged(e,t,i,r,o){const a={...("view"===e?this._config.view_visible_users:this._config.section_visible_users)||{}},s=new Set(Object.prototype.hasOwnProperty.call(a,t)?a[t]:r);o?s.add(i):s.delete(i),r.every(e=>s.has(e))&&[...s].every(e=>r.includes(e))?delete a[t]:a[t]=[...s];const n={...this._config};"view"===e?Object.keys(a).length?n.view_visible_users=a:delete n.view_visible_users:Object.keys(a).length?n.section_visible_users=a:delete n.section_visible_users,this._fireConfigChanged(n)}_renderCustomContentSection(){return r.qy`
      <div class="section">
            ...
            >
              ${["custom_cards","overview","areas","weather","energy"].map(t=>r.qy`
                  <option value=${t} ?selected=${(e.target_section||"custom_cards")===t}>
                    ${(0,ee.k)(_e._sectionMeta.get(t).labelKey)}
                  </option>
                `)}
            </select>
          </div>
    ...
    `}_renderAreaItems(e,t,i,o){if(0===e.length)return r.qy`<div class="empty-state">${(0,ee.k)("editor.no_areas")}</div>`;const a=new Map(i.map((e,t)=>[e,t])),s=new Map(e.map((e,t)=>[e.area_id,t]));return[...e].sort((e,t)=>{const i=a.get(e.area_id),r=a.get(t.area_id);return(void 0!==i?i:9999+(s.get(e.area_id)??0))-(void 0!==r?r:9999+(s.get(t.area_id)??0))}).map(e=>{const i=t.includes(e.area_id),a=this._expandedAreas.has(e.area_id),s=this._areaEntitiesCache.get(e.area_id),n=o.includes(e.area_id);return r.qy`
        ...
        >
          <div class="area-header">
            ...
            <button
              class="expand-button ${a?"expanded":""}"
              data-area-id=${e.area_id}
      ...
      <div class="custom-item" data-index=${i}>
        ...
        <div class="custom-item-fields">
          ...
          <div class="custom-card-target">
            ...
            >
              <option value="top" ?selected=${"top"===s}>
                ${(0,ee.k)("editor.area_custom_card_position_top")}
              </option>
              <option value="bottom" ?selected=${"bottom"===s}>
          ...
          <div class="custom-card-target">
            ...
            >
              <option value="yaml" ?selected=${"yaml"===a}>
                ${(0,ee.k)("editor.area_custom_card_mode_yaml")}
              </option>
              <option value="tile" ?selected=${"tile"===a}>
                ${(0,ee.k)("editor.area_custom_card_mode_tile")}
              </option>
              <option value="section" ?selected=${"section"===a}>
    ...
    `}_renderCardEditor(){const e=pe.find(e=>e.type===this._cardPickerSelectedType)?.name||this._cardPickerSelectedType;return r.qy`
      <div class="card-picker-overlay" @click=${this._handlePickerOverlayClick}>
        <div class="card-picker-dialog" @click=${e=>e.stopPropagation()}>
          <div class="card-picker-header">
            <button
    ...
    `}}function ue(e,t){return t.areas_options?.[e]?.groups_options?.badges?.additional||[]}function ge(e,t){const i=new Set;for(const r of e){const e=t.states[r];if(!e)continue;const o=e.attributes?.device_class;(0,te.g7)(o)&&i.add(r)}return i}function me(e,t){const i=t.areas_options?.[e]?.groups_options?.badges;return{namesVisible:i?.names_visible||[],namesHidden:i?.names_hidden||[]}}function fe(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.hidden&&(r[e]=t.hidden);return r}function ye(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.order&&(r[e]=t.order);return r}_e.properties={_config:{state:!0},_expandedAreas:{state:!0},_expandedGroups:{state:!0},_expandedWeatherBlocks:{state:!0},_cardPickerOpen:{state:!0},_cardPickerStep:{state:!0},_cardPickerSearch:{state:!0},_cardPickerSelectedType:{state:!0},_cardPickerYaml:{state:!0},_cardPickerHasVisualEditor:{state:!0}},_e.styles=[re,r.AH`
      /* -- Base layout --------------------------------------------------- */
      .card-config {
        padding: 16px;
