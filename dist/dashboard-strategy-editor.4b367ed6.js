        ...
        ${r.qy`
          ...
          <div class="form-row">
            <label for="house-mode-entity" style="margin-right: 8px; min-width: 120px;"
              >${(0,ee.k)("editor.house_mode_entity")}</label
            >
