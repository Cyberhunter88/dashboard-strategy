        ...
        <div class="entity-list">
          ...
          ${"native"===i?r.qy`
              ...
              `:r.qy`
                ...
                ></textarea>
                ${l?r.qy`<div style="color: var(--error-color); font-size: 12px; margin-top: 4px;">${l}</div>`:r.s6}
                ...
                ></textarea>
                ${d?r.qy`<div style="color: var(--error-color); font-size: 12px; margin-top: 4px;">${d}</div>`:r.s6}
