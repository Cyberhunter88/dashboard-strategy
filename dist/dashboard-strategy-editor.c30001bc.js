...
"use strict";(self.webpackChunkdashboard_strategy=self.webpackChunkdashboard_strategy||[]).push([[8],{842(e,t,i){i.r(t);var r=i(684),a=i(534),o=i(382),s=i(217),n=i(475),c=i(113),l=i(563);function d(e){return(e instanceof Error?e.message.split("\n")[0]:"UngÃ¼ltiges YAML")||"UngÃ¼ltiges YAML"}function p(e,t){if(!e.trim())return{parsed_config:void 0};try{const i=o.Ay.load(e);return i&&"object"==typeof i?{parsed_config:i}:{parsed_config:void 0,_yaml_error:t}}catch(e){return{parsed_config:void 0,_yaml_error:d(e)}}}const h=[{type:"tile",name:"Kachel",icon:"mdi:square-rounded",template:'type: tile\nentity: ""\n'},{type:"entities",name:"Entitätsliste",icon:"mdi:format-list-bulleted",template:'type: entities\nentities:\n  - entity: ""\n'},{type:"glance",name:"Glance",icon:"mdi:eye",template:'type: glance\nentities:\n  - entity: ""\n'},{type:"button",name:"Button",icon:"mdi:gesture-tap-button",template:'type: button\nentity: ""\ntap_action:\n  action: toggle\n'},{type:"markdown",name:"Text / Markdown",icon:"mdi:language-markdown",template:'type: markdown\ncontent: "**Text**"\n'},{type:"heading",name:"Überschrift",icon:"mdi:format-header-1",template:'type: heading\nheading: "Überschrift"\nheading_style: title\nicon: mdi:home\n'},{type:"weather-forecast",name:"Wettervorhersage",icon:"mdi:weather-partly-cloudy",template:'type: weather-forecast\nentity: ""\nshow_current: true\nshow_forecast: true\nforecast_type: daily\n'},{type:"gauge",name:"Messanzeige",icon:"mdi:gauge",template:'type: gauge\nentity: ""\nmin: 0\nmax: 100\n'},{type:"thermostat",name:"Thermostat",icon:"mdi:thermostat",template:'type: thermostat\nentity: ""\n'},{type:"media-control",name:"Mediensteuerung",icon:"mdi:play-circle",template:'type: media-control\nentity: ""\n'},{type:"history-graph",name:"Verlaufsgraph",icon:"mdi:chart-line",template:'type: history-graph\nentities:\n  - entity: ""\nhours_to_show: 24\n'},{type:"statistics-graph",name:"Statistikgraph",icon:"mdi:chart-bar",template:'type: statistics-graph\nentities:\n  - entity: ""\nstat_types:\n  - mean\nchart_type: line\nperiod: 5minute\n'},{type:"picture",name:"Bild",icon:"mdi:image",template:'type: picture\nimage: ""\n'},{type:"picture-entity",name:"Entity-Bild",icon:"mdi:image-outline",template:'type: picture-entity\nentity: ""\n'},{type:"map",name:"Karte",icon:"mdi:map",template:'type: map\nentities:\n  - entity: ""\n'},{type:"todo-list",name:"Aufgabenliste",icon:"mdi:checkbox-marked-circle",template:'type: todo-list\nentity: ""\n'},{type:"logbook",name:"Logbuch",icon:"mdi:history",template:'type: logbook\nentity: ""\nhours_to_show: 24\n'},{type:"alarm-panel",name:"Alarmanlage",icon:"mdi:shield-home",template:'type: alarm-panel\nentity: ""\n'},{type:"energy-distribution",name:"Energieverteilung",icon:"mdi:lightning-bolt",template:"type: energy-distribution\n"},{type:"grid",name:"Raster",icon:"mdi:grid",template:"type: grid\ncards: []\n"}];class u extends r.WF{constructor(){super(...arguments),this._hass=null,this._isUpdatingConfig=!1,this._config={},this._expandedAreas=new Set,this._expandedGroups=new Map,this._expandedWeatherBlocks=new Set,this._favoriteSearch="",this._roomPinSearch="",this._areaEntitiesCache=new Map,this._entitySelectOptionsCache=null,this._weatherStartAreaOptionsCache=null,this._weatherStartFloorOptionsCache=null,this._draggedElement=null,this._sectionDraggedElement=null,this._stackDraggedElement=null,this._weatherStartDraggedElement=null,this._cardPickerOpen=!1,this._cardPickerStep="type",this._cardPickerSearch="",this._cardPickerSelectedType="",this._cardPickerYaml="",this._cardPickerHasVisualEditor=!1,this._cardPickerCallback=null,this._cardPickerConfig=null,this._openCardPickerForWeatherStartCard=()=>{this._openCardPicker(e=>{const t=this._createWeatherStartItemId("card"),i=o.Ay.dump(e).trim(),r=[...this._config.custom_cards||[],{id:t,editor_title:"",yaml:i,parsed_config:e}],a=[...this._getWeatherStartLayoutItems(),{id:`custom-card-${t}`,type:"custom_card",custom_card_id:t}],s={...this._config,custom_cards:r,weather_start_layout_items:a};this._config=s,this._fireConfigChanged(s),this._expandedWeatherBlocks=new Set([...this._expandedWeatherBlocks,`custom-card-${t}`])})},this._handleWeatherStartDragStart=e=>{if(!e.target.closest(".drag-handle"))return void e.preventDefault();const t=e.target.closest(".section-order-item");t?(t.classList.add("dragging"),e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",t.dataset.wsId||"")),this._weatherStartDraggedElement=t):e.preventDefault()},this._handleWeatherStartDragEnd=e=>{const t=e.target.closest(".section-order-item");t&&t.classList.remove("dragging");const i=this.shadowRoot?.querySelector("#weather-start-order-list");i&&i.querySelectorAll(".section-order-item").forEach(e=>{e.classList.remove("drag-over")}),this._weatherStartDraggedElement=null},this._handleWeatherStartDragOver=e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const t=e.currentTarget;t!==this._weatherStartDraggedElement&&t.classList.add("drag-over")},this._handleWeatherStartDragLeave=e=>{e.currentTarget.classList.remove("drag-over")},this._handleWeatherStartDrop=e=>{e.stopPropagation(),e.preventDefault();const t=e.currentTarget;if(t.classList.remove("drag-over"),!this._weatherStartDraggedElement||this._weatherStartDraggedElement===t)return;const i=this._weatherStartDraggedElement.dataset.wsId,r=t.dataset.wsId;if(!i||!r)return;const a=this._getWeatherStartLayoutItems(),o=a.findIndex(e=>e.id===i),s=a.findIndex(e=>e.id===r);if(-1===o||-1===s)return;const n=[...a];n.splice(o,1),n.splice(s,0,a[o]),this._saveWeatherStartLayoutItems(n)},this._handleSectionDragStart=e=>{if(!e.target.closest(".drag-handle"))return void e.preventDefault();const t=e.target.closest(".section-order-item");t?(t.classList.add("dragging"),e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",t.dataset.sectionKey||"")),this._sectionDraggedElement=t):e.preventDefault()},this._handleSectionDragEnd=e=>{const t=e.target.closest(".section-order-item");t&&t.classList.remove("dragging");const i=this.shadowRoot?.querySelector("#section-order-list");i&&i.querySelectorAll(".section-order-item").forEach(e=>{e.classList.remove("drag-over")}),this._sectionDraggedElement=null},this._handleSectionDragOver=e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const t=e.currentTarget;t!==this._sectionDraggedElement&&t.classList.add("drag-over")},this._handleSectionDragLeave=e=>{e.currentTarget.classList.remove("drag-over")},this._handleSectionDrop=e=>{e.stopPropagation(),e.preventDefault();const t=e.currentTarget;if(t.classList.remove("drag-over"),!this._sectionDraggedElement||this._sectionDraggedElement===t)return;const i=this._sectionDraggedElement.dataset.sectionKey,r=t.dataset.sectionKey;if(!i||!r)return;const a=this._getSectionsOrder(),o=a.indexOf(i),s=a.indexOf(r);if(-1===o||-1===s)return;const n=[...a];n.splice(o,1),n.splice(s,0,i),this._updateSectionsOrder(n)},this._handleStackDragStart=e=>{if(!e.target.closest(".drag-handle"))return void e.preventDefault();const t=e.target.closest(".section-order-item");t?(t.classList.add("dragging"),e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",t.dataset.stackKey||"")),this._stackDraggedElement=t):e.preventDefault()},this._handleStackDragEnd=e=>{const t=e.target.closest(".section-order-item");t&&t.classList.remove("dragging"),this.shadowRoot?.querySelectorAll(".section-order-item.drag-over").forEach(e=>e.classList.remove("drag-over")),this._stackDraggedElement=null},this._handleStackDragOver=e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const t=e.currentTarget;t!==this._stackDraggedElement&&t.classList.add("drag-over")},this._handleStackDragLeave=e=>{e.currentTarget.classList.remove("drag-over")},this._handleStackDrop=e=>{e.stopPropagation(),e.preventDefault();const t=e.currentTarget;if(t.classList.remove("drag-over"),!this._stackDraggedElement||this._stackDraggedElement===t)return;const i=this._stackDraggedElement.dataset.stackKey,r=t.dataset.stackKey,a=t.dataset.areaId;if(!i||!r||!a)return;const o=this._getStacksOrder(a),s=o.indexOf(i),n=o.indexOf(r);if(-1===s||-1===n)return;const c=[...o];c.splice(s,1),c.splice(n,0,i),this._updateStacksOrder(a,c)},this._themeChanged=e=>{if(!this._hass)return;const t=e.target.value.trim(),i={...this._config};t?i.theme=t:delete i.theme,this._config=i,this._fireConfigChanged(i)},this._overviewLayoutChanged=e=>{if(!this._hass)return;const t=e.target.value,i={...this._config};"weather_start"===t?i.overview_layout=t:delete i.overview_layout,this._config=i,this._fireConfigChanged(i)},this._handleDragStart=e=>{if(!e.target.closest(".drag-handle"))return void e.preventDefault();const t=e.target.closest(".area-item");t?(t.classList.add("dragging"),e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",t.dataset.areaId||"")),this._draggedElement=t):e.preventDefault()},this._handleDragEnd=e=>{const t=e.target.closest(".area-item");t&&t.classList.remove("dragging");const i=this.shadowRoot.querySelector("#area-list");i&&i.querySelectorAll(".area-item").forEach(e=>{e.classList.remove("drag-over")})},this._handleDragOver=e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const t=e.currentTarget;t!==this._draggedElement&&t.classList.add("drag-over")},this._handleDragLeave=e=>{e.currentTarget.classList.remove("drag-over")},this._handleDrop=e=>{e.stopPropagation(),e.preventDefault();const t=e.currentTarget;if(t.classList.remove("drag-over"),!this._draggedElement||this._draggedElement===t)return;const i=this._draggedElement.dataset.areaId,r=t.dataset.areaId;if(!i||!r)return;const a=this._getAreaOrder(),o=a.indexOf(i),s=a.indexOf(r);if(-1===o||-1===s)return;const n=[...a];n.splice(o,1),n.splice(s,0,i),this._updateAreaOrder(n)},this._entityDraggedId=null,this._handleEntityDragStart=(e,t)=>{const i=e.target.closest(".entity-list-item");i?(i.classList.add("dragging"),this._entityDraggedId=i.dataset.entityId||null,e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",this._entityDraggedId||""))):e.preventDefault()},this._handleEntityDragEnd=e=>{const t=e.target.closest(".entity-list-item");t&&t.classList.remove("dragging"),this._entityDraggedId=null},this._handleEntityDragOver=e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const t=e.currentTarget;t.dataset.entityId!==this._entityDraggedId&&t.classList.add("drag-over")},this._handleEntityDragLeave=e=>{e.currentTarget.classList.remove("drag-over")},this._handleEntityDrop=(e,t)=>{e.stopPropagation(),e.preventDefault();const i=e.currentTarget;i.classList.remove("drag-over");const r=this._entityDraggedId,a=i.dataset.entityId;if(!r||!a||r===a)return;const o="favorites"===t?[...this._config.favorite_entities||[]]:[...this._config.room_pin_entities||[]],s=o.indexOf(r),n=o.indexOf(a);if(-1===s||-1===n)return;o.splice(s,1),o.splice(n,0,r);const c="favorites"===t?"favorite_entities":"room_pin_entities",l={...this._config,[c]:o};this._config=l,this._fireConfigChanged(l)},this._openCardPickerForCustomCard=()=>{this._openCardPicker(e=>{const t=o.Ay.dump(e).trim(),i=[...this._config.custom_cards||[]];i.push({editor_title:"",yaml:t,parsed_config:e});const r={...this._config,custom_cards:i};this._config=r,this._fireConfigChanged(r)})},this._handlePickerOverlayClick=e=>{e.target===e.currentTarget&&this._closeCardPicker()}}set hass(e){const t=this._hass;this._hass=e,!t||t.entities===e.entities&&t.devices===e.devices&&t.states===e.states||(this._entitySelectOptionsCache=null),!t||t.areas===e.areas&&t.floors===e.floors||(this._weatherStartAreaOptionsCache=null,this._weatherStartFloorOptionsCache=null),t||this.requestUpdate()}setConfig(e){this._isUpdatingConfig||(this._config.areas_display?.hidden===e.areas_display?.hidden&&this._config.areas_display?.order===e.areas_display?.order&&this._config.areas_display?.nav_items===e.areas_display?.nav_items||this._invalidateWeatherStartOptionsCaches(),this._config=e)}_invalidateWeatherStartOptionsCaches(){this._weatherStartAreaOptionsCache=null,this._weatherStartFloorOptionsCache=null}_checkSearchCardDependencies(){const e=void 0!==customElements.get("search-card"),t=void 0!==customElements.get("card-tools");return e&&t}_getAllEntitiesForSelect(){if(!this._hass)return[];if(this._entitySelectOptionsCache&&this._entitySelectOptionsCache.entities===this._hass.entities&&this._entitySelectOptionsCache.devices===this._hass.devices&&this._entitySelectOptionsCache.states===this._hass.states)return this._entitySelectOptionsCache.options;const e=this._hass.entities||{},t=Object.values(this._hass.devices||{}),i=new Map;t.forEach(e=>{e.area_id&&i.set(e.id,e.area_id)});const r=this._hass,a=Object.keys(r.states).map(t=>{const a=r.states[t],o=e[t];let s=o?.area_id;return!s&&o?.device_id&&(s=i.get(o.device_id)??null),{entity_id:t,name:a.attributes?.friendly_name||t.split(".")[1].replace(/_/g," "),area_id:s,device_area_id:s}}).sort((e,t)=>e.name.localeCompare(t.name));return this._entitySelectOptionsCache={entities:this._hass.entities,devices:this._hass.devices,states:this._hass.states,options:a},a}_getAlarmEntities(){return this._hass?Object.keys(this._hass.states).filter(e=>e.startsWith("alarm_control_panel.")).map(e=>{const t=this._hass.states[e];return{entity_id:e,name:t.attributes?.friendly_name||e.split(".")[1].replace(/_/g," ")}}).sort((e,t)=>e.name.localeCompare(t.name)):[]}_getWeatherEntities(){return this._hass?Object.keys(this._hass.states).filter(e=>e.startsWith("weather.")).map(e=>{const t=this._hass.states[e];return{entity_id:e,name:t.attributes?.friendly_name||e.split(".")[1].replace(/_/g," ")}}).sort((e,t)=>e.name.localeCompare(t.name)):[]}_getThemeNames(){return this._hass?.themes?.themes?Object.keys(this._hass.themes.themes).sort((e,t)=>e.localeCompare(t)):[]}_getFilteredEntities(e,t=!1){if(!this._hass||e.length<2)return[];const i=e.toLowerCase(),r=this._getAllEntitiesForSelect().filter(e=>!(t&&!e.area_id&&!e.device_area_id)&&(e.name.toLowerCase().includes(i)||e.entity_id.toLowerCase().includes(i)));return r.sort((e,t)=>{const r=e.name.toLowerCase(),a=t.name.toLowerCase(),o=e.entity_id.toLowerCase(),s=t.entity_id.toLowerCase(),n=r===i||o===i;if(n!==(a===i||s===i))return n?-1:1;const c=r.startsWith(i)||o.startsWith(i)||o.split(".")[1]?.startsWith(i);return c!==(a.startsWith(i)||s.startsWith(i)||s.split(".")[1]?.startsWith(i))?c?-1:1:r.localeCompare(a)}),r.slice(0,21)}render(){return this._hass?r.qy`
      <div class="card-config">
        ...
        <div class="section-divider">
          <div class="section-divider-title">
            ${(0,n.localize)("editor.section_areas_rooms")}
          </div>
        </div>
        ...
        <div class="section-divider">
          <div class="section-divider-title">
            ${(0,n.localize)("editor.section_advanced")}
          </div>
        </div>
    ...
    `:r.s6}_renderAdvancedOptionsSection(){const e=!0===this._config.hide_unavailable_entities;return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_advanced_options")}</div>

        ${this._renderCheckbox("hide-unavailable-entities",(0,n.localize)("editor.hide_unavailable_entities"),e,e=>this._toggleChanged("hide_unavailable_entities",e,!1))}
        <div class="description">${(0,n.localize)("editor.hide_unavailable_entities_desc")}</div>
      </div>
    `}_getSectionsOrder(){return this._config.sections_order||[...s.GC]}_updateSectionsOrder(e){const t={...this._config,sections_order:e};this._config=t,this._fireConfigChanged(t)}_isSectionDisabled(e){switch(e){case"custom_cards":return 0===(this._config.custom_cards||[]).length;case"custom_sections":return 0===(this._config.custom_sections||[]).length;case"weather":return!1===this._config.show_weather;case"energy":return!1===this._config.show_energy;default:return!1}}_isSectionToggleable(e){return"weather"===e||"energy"===e}_toggleSectionVisibility(e,t){"weather"===e?this._toggleChanged("show_weather",t,!0):"energy"===e&&this._toggleChanged("show_energy",t,!0)}_renderSectionOrderPanel(){const e=this._getSectionsOrder(),t=!1!==this._config.energy_link_dashboard,i=!1!==this._config.show_energy;return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_order")}</div>
        <div class="description" style="margin-left: 0; margin-bottom: 12px;">
          ${(0,n.localize)("editor.section_order_desc")}
        </div>
        <div class="section-order-list" id="section-order-list">
          ${e.map(e=>{const a=u._sectionMeta.get(e);if(!a)return r.s6;const o=this._isSectionDisabled(e),s=this._isSectionToggleable(e);return r.qy`
              <div class="section-order-item ${o?"disabled":""}"
                ...
                <span class="section-label">${(0,n.localize)(a.labelKey)}</span>
                ${o&&!s?r.qy`<span class="section-hidden-tag">(${(0,n.localize)("editor.section_hidden")})</span>`:r.s6}
                ${s?r.qy`
    ...
    `}_renderWeatherStartCustomSectionEditor(e,t){const i=e.cards||[];return r.qy`
      <div class="custom-item-row" style="margin-bottom: 8px;">
        <input type="text"
          .value=${e.title||""}
          placeholder=${(0,n.localize)("editor.custom_section_title_placeholder")}
          style="flex: 2;"
          @change=${e=>this._updateCustomSectionField(t,"title",e.target.value)} />
        <input type="text"
          .value=${e.icon||""}
          placeholder=${(0,n.localize)("editor.custom_section_icon_placeholder")}
          style="flex: 1;"
          @change=${e=>this._updateCustomSectionField(t,"icon",e.target.value)} />
      </div>
      <div class="description" style="margin: 0 0 8px 0;">${(0,n.localize)("editor.weather_start_section_cards_desc")}</div>
      ${0===i.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_custom_cards")}</div>`:i.map((e,i)=>{const a=e._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${e._yaml_error}</span>`:e.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
            <div class="custom-item" style="margin-bottom: 8px;">
              <div class="custom-item-header">
                <strong>${this._getCustomCardEditorLabel(e,`${(0,n.localize)("editor.new_card")} ${i+1}`)}</strong>
                <button class="btn-remove" @click=${()=>this._removeCardFromSection(t,i)}>&#x2715;</button>
              </div>
              <div class="custom-item-fields">
                <label>${(0,n.localize)("editor.card_editor_title_label")}</label>
                <input type="text" .value=${e.editor_title||""} placeholder=${(0,n.localize)("editor.card_editor_title_placeholder")}
                  @change=${e=>this._updateSectionCardField(t,i,"editor_title",e.target.value)} />
                <div class="description" style="margin: 0 0 4px 0;">${(0,n.localize)("editor.card_editor_title_help")}</div>
                <label>${(0,n.localize)("editor.card_dashboard_title_label")}</label>
                <input type="text" .value=${e.title||""} placeholder=${(0,n.localize)("editor.card_title_placeholder")}
                  @change=${e=>this._updateSectionCardField(t,i,"title",e.target.value)} />
                <textarea rows="5" placeholder=${(0,n.localize)("editor.yaml_placeholder")}
                  .value=${e.yaml||""}
                  style="width: 100%;"
          ...
          ${e.map(e=>{const i=this._getWeatherStartItemMeta(e,t,a,o),s=this._isWeatherStartItemDisabled(e,a,o),c=this._expandedWeatherBlocks.has(e.id),l=!!e.yaml,d="area"!==e.type&&"floor"!==e.type,p=this._getWeatherStartCustomCardIndex(e,a),h=p>=0?a[p]:void 0,u=this._getWeatherStartCustomSectionIndex(e,o),_=u>=0?o[u]:void 0;return r.qy`
              <div>
                <div class="section-order-item ${s?"disabled":""}"
                  ...
                  ${s?r.qy`<span class="section-hidden-tag">(${(0,n.localize)("editor.section_hidden")})</span>`:r.s6}
                  ${l?r.qy`<span class="section-hidden-tag" style="background:var(--primary-color);color:#fff;margin-left:4px;">✎</span>`:r.s6}
                  <button class="icon-btn" style="margin-left:auto;"
                    title=${(0,n.localize)("editor.weather_start_block_expand")}
                  ...
                  ${d?r.qy`
                    <button class="icon-btn"
                      title=${(0,n.localize)("editor.remove")}
                ...
                ${c?r.qy`
                  <div style="padding: 8px 12px 12px 12px; background: var(--secondary-background-color); border-radius: 0 0 8px 8px; margin-bottom: 4px;">
                    ${h?this._renderWeatherStartCustomCardEditor(h,p):r.s6}
                    ${_?this._renderWeatherStartCustomSectionEditor(_,u):r.s6}
                    ${h||_||"summaries"!==e.type?r.s6:r.qy`
                      <label class="form-row" style="margin: 0 0 8px 0;">
                        <span style="min-width: 120px;">${(0,n.localize)("editor.weather_start_summary_size")}</span>
                        <select
                          style="flex:1;"
                          .value=${e.summary_size||"mini"}
                          @change=${t=>this._weatherStartSummarySizeChanged(e.id,t.target.value)}>
                          <option value="mini">${(0,n.localize)("editor.weather_start_summary_size_mini")}</option>
                          <option value="normal">${(0,n.localize)("editor.weather_start_summary_size_normal")}</option>
                        </select>
                      </label>
                    `}
                    ${h||_?r.s6:r.qy`
                      ...
                      <span>${(0,n.localize)("editor.weather_start_stack_with_previous")}</span>
                      </label>
                      <div class="description" style="margin: 0 0 6px 0;">${(0,n.localize)("editor.weather_start_block_yaml_desc")}</div>
                      <textarea
                        rows="6"
                        style="width:100%;box-sizing:border-box;font-family:monospace;font-size:12px;resize:vertical;"
                        placeholder=${(0,n.localize)("editor.yaml_placeholder")}
                      ...
                      ${e.parsed_config?r.qy`<div style="color:var(--success-color,green);font-size:12px;margin-top:4px;">${(0,n.localize)("editor.yaml_valid")}</div>`:r.s6}
                      ${l?r.qy`
                        <button class="text-btn" style="margin-top:8px;"
                          @click=${()=>this._resetWeatherStartItemYaml(e.id)}>
                          ${(0,n.localize)("editor.weather_start_block_reset")}
                        </button>
                      `:r.s6}
                    `}
                  </div>
          ...
          <div class="section-order-list" data-area-id=${e}>
            ${o.map(t=>{const i=u._stackMeta.get(t);return i?r.qy`
                <div class="section-order-item"
                  ...
                  <span class="drag-handle" draggable="true">&#x2630;</span>
                  <ha-icon class="section-icon" icon=${i.icon}></ha-icon>
                  <span class="section-label">${(0,n.localize)(i.labelKey)}</span>
                </div>
              `:r.s6})}
          </div>
          ${s.length>0?r.qy`
              <div class="section-order-compact">
                <div class="compact-title">${(0,n.localize)("editor.stack_order_inactive")}</div>
                <div class="compact-chip-list">
                  ${s.map(e=>{const t=u._stackMeta.get(e);return t?r.qy`
                      <span class="compact-chip">
                        <ha-icon icon=${t.icon}></ha-icon>
                        ${(0,n.localize)(t.labelKey)}
                      </span>
                    `:r.s6})}
                </div>
              </div>
    ...
    `}_renderOverviewSection(){const e=!1!==this._config.show_clock_card,t=!0===this._config.show_search_card,i=this._checkSearchCardDependencies(),o=this._config.alarm_entity||"",s=this._getAlarmEntities(),c=this._config.weather_entity||"",l=this._getWeatherEntities(),d=this._config.theme||"",p=this._getThemeNames(),h=this._config.overview_layout||"default";return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_overview")}</div>

        <div class="form-row">
          <label for="dashboard-theme" style="margin-right: 8px; min-width: 120px;">${(0,n.localize)("editor.theme")}</label>
          <select id="dashboard-theme"
            style="flex: 1;"
            @change=${this._themeChanged}>
            <option value="" ?selected=${!d}>${(0,n.localize)("editor.theme_default")}</option>
            ${p.map(e=>r.qy`
              <option value=${e} ?selected=${e===d}>${e}</option>
            `)}
          </select>
        </div>
        <div class="description">${(0,n.localize)("editor.theme_desc")}</div>

        <div class="form-row">
          <label for="overview-layout" style="margin-right: 8px; min-width: 120px;">${(0,n.localize)("editor.overview_layout")}</label>
          <select id="overview-layout"
            style="flex: 1;"
            @change=${this._overviewLayoutChanged}>
            <option value="default" ?selected=${"default"===h}>${(0,n.localize)("editor.overview_layout_default")}</option>
            <option value="weather_start" ?selected=${"weather_start"===h}>${(0,n.localize)("editor.overview_layout_weather_start")}</option>
          </select>
        </div>
        <div class="description">${(0,n.localize)("editor.overview_layout_desc")}</div>

        <div class="form-row">
          <label for="weather-entity" style="margin-right: 8px; min-width: 120px;">${(0,n.localize)("editor.weather_entity")}</label>
          <select id="weather-entity"
            style="flex: 1;"
            @change=${this._weatherEntityChanged}>
            <option value="" ?selected=${!c}>${(0,n.localize)("editor.weather_entity_auto")}</option>
            ${l.map(e=>r.qy`
              <option value=${e.entity_id} ?selected=${e.entity_id===c}>
                ${e.name}
              </option>
            `)}
          </select>
        </div>
        <div class="description">${(0,n.localize)("editor.weather_entity_desc")}</div>

        ${"weather_start"===h?this._renderWeatherStartOrderPanel():r.s6}

        ${"weather_start"!==h?r.qy`
          ${this._renderCheckbox("show-clock-card",(0,n.localize)("editor.show_clock_card"),e,e=>this._toggleChanged("show_clock_card",e,!0))}
          <div class="description">${(0,n.localize)("editor.show_clock_card_desc")}</div>

          <div class="form-row">
            <label for="alarm-entity" style="margin-right: 8px; min-width: 120px;">${(0,n.localize)("editor.alarm_entity")}</label>
            <select id="alarm-entity"
              style="flex: 1;"
              @change=${this._alarmEntityChanged}>
              <option value="" ?selected=${!o}>${(0,n.localize)("editor.alarm_none")}</option>
              ${s.map(e=>r.qy`
          ...
          <div class="description">${(0,n.localize)("editor.alarm_desc")}</div>

          ${this._renderCheckbox("show-search-card",(0,n.localize)("editor.show_search_card"),t,e=>this._toggleChanged("show_search_card",e,!1),!i)}
          <div class="description">
            ${i?(0,n.localize)("editor.show_search_card_desc"):r.qy`<span>&#x26A0;&#xFE0F; ${(0,a._)((0,n.localize)("editor.show_search_card_missing"))}</span>`}
          </div>
        `:r.s6}
      </div>
    `}_renderSummariesSection(){const e=this._config.summaries_columns||2,t=!1!==this._config.show_light_summary,i=!0===this._config.group_lights_by_floors,a=!0===this._config.nested_light_groups,o=!1!==this._config.show_covers_summary,s=!0===this._config.show_partially_open_covers,c=!1!==this._config.show_security_summary,l=!0===this._config.show_climate_summary,d=!1!==this._config.show_battery_summary,p=!0===this._config.hide_mobile_app_batteries,h=this._config.battery_critical_threshold??20,u=this._config.battery_low_threshold??50;return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_summaries")}</div>

        <div class="form-row">
          <input type="radio" id="summaries-2-columns" name="summaries-columns" value="2"
            ?checked=${2===e}
            @change=${()=>this._summariesColumnsChanged(2)} />
          <label for="summaries-2-columns">${(0,n.localize)("editor.columns_2")}</label>
        </div>
        <div class="form-row">
          <input type="radio" id="summaries-4-columns" name="summaries-columns" value="4"
            ?checked=${4===e}
            @change=${()=>this._summariesColumnsChanged(4)} />
          <label for="summaries-4-columns">${(0,n.localize)("editor.columns_4")}</label>
        </div>
        <div class="description">${(0,n.localize)("editor.columns_desc")}</div>

        ${this._renderCheckbox("show-light-summary",(0,n.localize)("editor.show_light_summary"),t,e=>this._toggleChanged("show_light_summary",e,!0))}

        ${this._renderCheckbox("group-lights-by-floors",(0,n.localize)("editor.group_lights_by_floors"),i,e=>this._toggleChanged("group_lights_by_floors",e,!1))}
        <div class="description">${(0,n.localize)("editor.group_lights_by_floors_desc")}</div>

        ${this._renderCheckbox("nested-light-groups",(0,n.localize)("editor.nested_light_groups"),a,e=>this._toggleChanged("nested_light_groups",e,!1))}
        <div class="description">${(0,n.localize)("editor.nested_light_groups_desc")}</div>

        ${this._renderCheckbox("show-covers-summary",(0,n.localize)("editor.show_covers_summary"),o,e=>this._toggleChanged("show_covers_summary",e,!0))}

        <div style="margin-left: 26px; margin-bottom: 8px;">
          ${this._renderCheckbox("show-partially-open-covers",(0,n.localize)("editor.show_partially_open_covers"),s,e=>this._toggleChanged("show_partially_open_covers",e,!1))}
          <div class="description">${(0,n.localize)("editor.show_partially_open_covers_desc")}</div>
        </div>

        ${this._renderCheckbox("show-security-summary",(0,n.localize)("editor.show_security_summary"),c,e=>this._toggleChanged("show_security_summary",e,!0))}

        ${this._renderCheckbox("show-climate-summary",(0,n.localize)("editor.show_climate_summary"),l,e=>this._toggleChanged("show_climate_summary",e,!1))}
        <div class="description">${(0,n.localize)("editor.show_climate_summary_desc")}</div>

        ${this._renderCheckbox("show-battery-summary",(0,n.localize)("editor.show_battery_summary"),d,e=>this._toggleChanged("show_battery_summary",e,!0))}

        <div style="margin-left: 26px; margin-bottom: 8px;">
          ${this._renderCheckbox("hide-mobile-app-batteries",(0,n.localize)("editor.hide_mobile_app_batteries"),p,e=>this._toggleChanged("hide_mobile_app_batteries",e,!1))}
          <div class="description">${(0,n.localize)("editor.hide_mobile_app_batteries_desc")}</div>

          <div style="font-size: 13px; font-weight: 500; color: var(--primary-text-color); margin-top: 12px; margin-bottom: 4px;">
            ${(0,n.localize)("editor.battery_thresholds")}
          </div>
          <div class="form-row">
            <label for="battery-critical-threshold" style="min-width: 140px;">${(0,n.localize)("editor.battery_critical_below")}</label>
          ...
          <div class="form-row">
            <label for="battery-low-threshold" style="min-width: 140px;">${(0,n.localize)("editor.battery_low_below")}</label>
            <input type="number" id="battery-low-threshold" min="1" max="99"
              .value=${String(u)}
              style="width: 70px;"
              @change=${this._batteryLowChanged} /> %
          </div>
          <div class="description">${(0,n.localize)("editor.battery_thresholds_desc")}</div>
        </div>
      </div>
    `}_renderFavoritesSection(){const e=this._config.favorite_entities||[],t=this._getAllEntitiesForSelect(),i=!0===this._config.favorites_show_state,a=!0===this._config.favorites_hide_last_changed,o=new Map(t.map(e=>[e.entity_id,e.name])),s=this._getFilteredEntities(this._favoriteSearch);return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_favorites")}</div>

        <div id="favorites-list" style="margin-bottom: 12px;">
          ${0===e.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_favorites")}</div>`:r.qy`
        ...
        <div class="entity-search-picker">
          <input type="text" class="entity-search-input"
            placeholder=${(0,n.localize)("editor.select_entity")+"..."}
          ...
          ${this._favoriteSearch.length>=2?r.qy`
            <div class="entity-search-results">
              ${s.length>0?s.map(e=>r.qy`
                ...
                `):r.qy`<div class="entity-search-no-results">${(0,n.localize)("editor.no_results")}</div>`}
            </div>
          `:r.s6}
        </div>
        <div class="description">${(0,n.localize)("editor.favorites_desc")}</div>

        ${this._renderCheckbox("favorites-show-state",(0,n.localize)("editor.show_state"),i,e=>this._toggleChanged("favorites_show_state",e,!1))}

        ${this._renderCheckbox("favorites-hide-last-changed",(0,n.localize)("editor.hide_last_changed"),a,e=>this._toggleChanged("favorites_hide_last_changed",e,!1))}
      </div>
    `}_renderAreasSection(){const e=!0===this._config.group_by_floors,t=!0===this._config.show_switches_on_areas,i=!0===this._config.show_alerts_on_areas,a=!0===this._config.show_locks_in_rooms,o=!0===this._config.show_automations_in_rooms,s=!0===this._config.show_scripts_in_rooms,c=!0===this._config.use_default_area_sort,l=Object.values(this._hass.areas).sort((e,t)=>e.name.localeCompare(t.name)),d=this._config.areas_display?.hidden||[],p=this._config.areas_display?.order||[],h=this._config.areas_display?.nav_items||[];return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_areas")}</div>

        <div class="option-groups">
          <div class="option-group">
            <div class="option-group-title">
              <ha-icon icon="mdi:view-dashboard-outline"></ha-icon>
              <span>${(0,n.localize)("editor.area_overview_options")}</span>
            </div>
            ${this._renderCheckbox("group-by-floors",(0,n.localize)("editor.group_by_floors"),e,e=>this._toggleChanged("group_by_floors",e,!1))}
            <div class="description">${(0,n.localize)("editor.group_by_floors_desc")}</div>

            ${this._renderCheckbox("show-switches-on-areas",(0,n.localize)("editor.show_switches_on_areas"),t,e=>this._toggleChanged("show_switches_on_areas",e,!1))}
            <div class="description">${(0,n.localize)("editor.show_switches_on_areas_desc")}</div>

            ${this._renderCheckbox("show-alerts-on-areas",(0,n.localize)("editor.show_alerts_on_areas"),i,e=>this._toggleChanged("show_alerts_on_areas",e,!1))}
            <div class="description">${(0,n.localize)("editor.show_alerts_on_areas_desc")}</div>
          </div>

          <div class="option-group">
            <div class="option-group-title">
              <ha-icon icon="mdi:door-open"></ha-icon>
              <span>${(0,n.localize)("editor.room_view_options")}</span>
            </div>
            ${this._renderCheckbox("show-locks-in-rooms",(0,n.localize)("editor.show_locks_in_rooms"),a,e=>this._toggleChanged("show_locks_in_rooms",e,!1))}
            <div class="description">${(0,n.localize)("editor.show_locks_in_rooms_desc")}</div>

            ${this._renderCheckbox("show-automations-in-rooms",(0,n.localize)("editor.show_automations_in_rooms"),o,e=>this._toggleChanged("show_automations_in_rooms",e,!1))}
            <div class="description">${(0,n.localize)("editor.show_automations_in_rooms_desc")}</div>

            ${this._renderCheckbox("show-scripts-in-rooms",(0,n.localize)("editor.show_scripts_in_rooms"),s,e=>this._toggleChanged("show_scripts_in_rooms",e,!1))}
            <div class="description">${(0,n.localize)("editor.show_scripts_in_rooms_desc")}</div>
          </div>

          <div class="option-group">
            <div class="option-group-title">
              <ha-icon icon="mdi:sort-alphabetical-ascending"></ha-icon>
              <span>${(0,n.localize)("editor.area_management_options")}</span>
            </div>
            ${this._renderCheckbox("use-default-area-sort",(0,n.localize)("editor.use_default_area_sort"),c,e=>this._toggleChanged("use_default_area_sort",e,!1))}
            <div class="description">${(0,n.localize)("editor.use_default_area_sort_desc")}</div>
          </div>
        </div>

        <div class="description" style="margin-left: 0; margin-top: 16px; margin-bottom: 12px;">
          ${(0,n.localize)("editor.areas_manage_desc")}
        </div>

        <div class="area-list" id="area-list">
          ${this._renderAreaItems(l,d,p,h)}
        </div>
      </div>
    `}_renderRoomPinsSection(){const e=this._config.room_pin_entities||[],t=this._getAllEntitiesForSelect(),i=Object.values(this._hass.areas).sort((e,t)=>e.name.localeCompare(t.name)),o=!0===this._config.room_pins_show_state,s=!0===this._config.room_pins_hide_last_changed,c=new Map(t.map(e=>[e.entity_id,e])),l=new Map(i.map(e=>[e.area_id,e.name])),d=this._getFilteredEntities(this._roomPinSearch,!0);return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_room_pins")}</div>

        <div id="room-pins-list" style="margin-bottom: 12px;">
          ${0===e.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_room_pins")}</div>`:r.qy`
              <div class="entity-list-container">
                ${e.map(e=>{const t=c.get(e),i=t?.name||e,a=t?.area_id||t?.device_area_id,o=a?l.get(a)||a:(0,n.localize)("editor.no_room");return r.qy`
                    <div class="entity-list-item" data-entity-id=${e}
                      draggable="true"
        ...
        <div class="description">${(0,a._)((0,n.localize)("editor.room_pins_desc"))}</div>

        ${this._renderCheckbox("room-pins-show-state",(0,n.localize)("editor.show_state"),o,e=>this._toggleChanged("room_pins_show_state",e,!1))}

        ${this._renderCheckbox("room-pins-hide-last-changed",(0,n.localize)("editor.hide_last_changed"),s,e=>this._toggleChanged("room_pins_hide_last_changed",e,!1))}
      </div>
    `}_renderViewsSection(){const e=!0===this._config.show_summary_views,t=!0===this._config.show_room_views;return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_views")}</div>

        ${this._renderCheckbox("show-summary-views",(0,n.localize)("editor.show_summary_views"),e,e=>this._toggleChanged("show_summary_views",e,!1))}
        <div class="description">${(0,n.localize)("editor.show_summary_views_desc")}</div>

        ${this._renderCheckbox("show-room-views",(0,n.localize)("editor.show_room_views"),t,e=>this._toggleChanged("show_room_views",e,!1))}
        <div class="description">${(0,n.localize)("editor.show_room_views_desc")}</div>
      </div>
    `}_renderCustomContentSection(){const e="weather_start"===(this._config.overview_layout||"default");return r.qy`
      <div class="section">
        <div class="section-title">${(0,n.localize)("editor.section_custom_content")}</div>
        <div class="description" style="margin-left: 0; margin-bottom: 12px;">
          ${(0,n.localize)("editor.section_custom_content_desc")}
        </div>
        ${e?r.qy`
          <div class="empty-state" style="margin-bottom: 12px;">
            ${(0,n.localize)("editor.custom_content_weather_start_hint")}
          </div>
        `:r.s6}
    ...
    `}_renderCustomCardsSection(e=!1){const t=this._config.custom_cards||[],i=this._config.custom_cards_heading||"",a=this._config.custom_cards_icon||"";return r.qy`
      <div class=${e?"editor-subsection":"section"}>
        <div class=${e?"subsection-title":"section-title"} style="display: flex; align-items: center; gap: 8px;">
          ${(0,n.localize)("editor.section_custom_cards")}
          <a href="https://github.com/Cyberhunter88/dashboard-strategy/blob/main/assets/Eigene-Karten-hinzufugen.gif"
            ...
            title=${(0,n.localize)("editor.video_tutorial")}>&#x1F3AC;</a>
        </div>
        <div class="custom-item-row" style="margin-bottom: 12px;">
          <input type="text" id="custom-cards-heading"
            .value=${i}
            placeholder=${(0,n.localize)("editor.custom_cards_heading_placeholder")}
            style="flex: 2;"
        ...
        <div class="description" style="margin-bottom: 8px;">${(0,n.localize)("editor.custom_cards_desc")}</div>

        <div id="custom-cards-list">
          ${0===t.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_custom_cards")}</div>`:t.map((e,t)=>this._renderCustomCardItem(e,t))}
        </div>

        <button class="btn-primary" style="margin-top: 8px;" @click=${this._openCardPickerForCustomCard}>
          ${(0,n.localize)("editor.add_custom_card")}
        </button>
        <div class="description">${(0,n.localize)("editor.custom_cards_help")}</div>
      </div>
    `}_renderCustomSectionsSection(e=!1){const t=this._config.custom_sections||[];return r.qy`
      <div class=${e?"editor-subsection":"section"}>
        <div class=${e?"subsection-title":"section-title"}>${(0,n.localize)("editor.section_custom_sections")}</div>
        <div class="description" style="margin-bottom: 8px;">${(0,n.localize)("editor.custom_sections_help")}</div>

        <div id="custom-sections-list">
          ${0===t.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_custom_sections")}</div>`:t.map((e,t)=>this._renderCustomSectionItem(e,t))}
        </div>

        <button class="btn-primary" style="margin-top: 8px;" @click=${this._addCustomSection}>
          ${(0,n.localize)("editor.add_custom_section")}
        </button>
      </div>
    `}_renderCustomBadgesSection(e=!1){const t=this._config.custom_badges||[];return r.qy`
      <div class=${e?"editor-subsection":"section"}>
        <div class=${e?"subsection-title":"section-title"} style="display: flex; align-items: center; gap: 8px;">
          ${(0,n.localize)("editor.section_custom_badges")}
        ...
        <div id="custom-badges-list">
          ${0===t.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_custom_badges")}</div>`:t.map((e,t)=>this._renderCustomBadgeItem(e,t))}
        </div>

        <button class="btn-primary" style="margin-top: 8px;" @click=${this._addCustomBadge}>
          ${(0,n.localize)("editor.add_custom_badge")}
        </button>
        <div class="description">${(0,n.localize)("editor.custom_badges_help")}</div>
      </div>
    `}_renderCustomViewsSection(e=!1){const t=this._config.custom_views||[];return r.qy`
      <div class=${e?"editor-subsection":"section"}>
        <div class=${e?"subsection-title":"section-title"} style="display: flex; align-items: center; gap: 8px;">
          ${(0,n.localize)("editor.section_custom_views")}
        ...
        <div id="custom-views-list">
          ${0===t.length?r.qy`<div class="empty-state">${(0,n.localize)("editor.no_custom_views")}</div>`:t.map((e,t)=>this._renderCustomViewItem(e,t))}
        </div>

        <button class="btn-primary" style="margin-top: 8px;" @click=${this._addCustomView}>
          ${(0,n.localize)("editor.add_custom_view")}
        </button>
        <div class="description">${(0,n.localize)("editor.custom_views_help")}</div>
      </div>
    ...
    `}_renderCustomViewItem(e,t){const i=e._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${e._yaml_error}</span>`:e.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
      <div class="custom-item" data-index=${t}>
        <div class="custom-item-header">
          <strong>${e.title||(0,n.localize)("editor.new_view")}</strong>
          <button class="btn-remove" @click=${()=>this._removeCustomView(t)}>&#x2715;</button>
        </div>
        <div class="custom-item-fields">
          <div class="custom-item-row">
            <input type="text" .value=${e.title||""} placeholder=${(0,n.localize)("editor.title_placeholder")}
              style="flex: 2;"
              @change=${e=>this._updateCustomViewField(t,"title",e.target.value)} />
            <input type="text" .value=${e.path||""} placeholder=${(0,n.localize)("editor.path_placeholder")}
              style="flex: 2;"
          ...
          <textarea rows="8" placeholder=${(0,n.localize)("editor.yaml_placeholder")}
            .value=${e.yaml||""}
            style="width: 100%;"
    ...
    `}_renderCustomCardItem(e,t){const i=e._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${e._yaml_error}</span>`:e.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
      <div class="custom-item" data-index=${t}>
        <div class="custom-item-header">
          <strong>${this._getCustomCardEditorLabel(e,(0,n.localize)("editor.new_card"))}</strong>
        ...
        <div class="custom-item-fields">
          ...
          <div class="custom-card-target">
            <label>${(0,n.localize)("editor.target_section")}:</label>
            <select
              ...
              ${["custom_cards","overview","areas","weather","energy"].map(t=>r.qy`
                <option value=${t} ?selected=${(e.target_section||"custom_cards")===t}>
                  ${(0,n.localize)(u._sectionMeta.get(t).labelKey)}
                </option>
              `)}
            </select>
          </div>
          <textarea rows="6" placeholder=${(0,n.localize)("editor.yaml_placeholder")}
            .value=${e.yaml||""}
            style="width: 100%;"
    ...
    `}_renderCustomSectionItem(e,t){const i=e.cards||[];return r.qy`
      <div class="custom-item" data-index=${t} style="margin-bottom: 12px;">
        <div class="custom-item-header">
          <strong>${e.title||`${(0,n.localize)("editor.section_custom_sections")} ${t+1}`}</strong>
          <button class="btn-remove" @click=${()=>this._removeCustomSection(t)}>&#x2715;</button>
        </div>
        <div class="custom-item-fields">
          <div class="custom-item-row">
            <input type="text" .value=${e.title||""} placeholder=${(0,n.localize)("editor.custom_section_title_placeholder")}
              style="flex: 2;"
              @change=${e=>this._updateCustomSectionField(t,"title",e.target.value)} />
            <input type="text" .value=${e.icon||""} placeholder=${(0,n.localize)("editor.custom_section_icon_placeholder")}
              style="flex: 1;"
              @change=${e=>this._updateCustomSectionField(t,"icon",e.target.value)} />
          </div>
          <div style="margin-top: 8px; padding-left: 8px; border-left: 2px solid var(--divider-color, #e0e0e0);">
            ${i.map((e,i)=>{const a=e._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${e._yaml_error}</span>`:e.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
    ...
    `}_renderCustomBadgeItem(e,t){const i=e._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${e._yaml_error}</span>`:e.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
      <div class="custom-item" data-index=${t}>
        <div class="custom-item-header">
    ...
    `}_renderAreaItems(e,t,i,a){if(0===e.length)return r.qy`<div class="empty-state">${(0,n.localize)("editor.no_areas")}</div>`;const o=new Map(i.map((e,t)=>[e,t])),s=new Map(e.map((e,t)=>[e.area_id,t]));return[...e].sort((e,t)=>{const i=o.get(e.area_id),r=o.get(t.area_id);return(void 0!==i?i:9999+(s.get(e.area_id)??0))-(void 0!==r?r:9999+(s.get(t.area_id)??0))}).map(e=>{const i=t.includes(e.area_id),o=this._expandedAreas.has(e.area_id),s=this._areaEntitiesCache.get(e.area_id),c=a.includes(e.area_id);return r.qy`
        <div class="area-item"
          ...
          <div class="area-header">
            ...
            <button class="nav-pin-button ${c?"pinned":""}"
              title="${(0,n.localize)("editor.area_pin_nav")}"
              ?disabled=${i}
              @click=${t=>{t.stopPropagation(),this._areaNavPinChanged(e.area_id,!c)}}>
              <ha-icon icon="${c?"mdi:pin":"mdi:pin-outline"}"></ha-icon>
            </button>
          ...
          ${o?r.qy`
              <div class="area-content" data-area-id=${e.area_id}>
                ${s?this._renderAreaEntities(e.area_id,s):r.qy`<div class="loading-placeholder">${(0,n.localize)("editor.loading_entities")}</div>`}
              </div>
            `:r.s6}
        </div>
      `})}_renderAreaEntities(e,t){const{groupedEntities:i,hiddenEntities:a,badgeCandidates:o,additionalBadges:s,availableEntities:c,defaultShowNames:l,namesVisible:d,namesHidden:p}=t,h=this._hass,u=[{key:"lights",label:(0,n.localize)("editor.domain_lights"),icon:"mdi:lightbulb"},{key:"climate",label:(0,n.localize)("editor.domain_climate"),icon:"mdi:thermostat"},{key:"covers",label:(0,n.localize)("editor.domain_covers"),icon:"mdi:window-shutter"},{key:"covers_curtain",label:(0,n.localize)("editor.domain_covers_curtain"),icon:"mdi:curtains"},{key:"covers_window",label:(0,n.localize)("editor.domain_covers_window"),icon:"mdi:window-open-variant"},{key:"media_player",label:(0,n.localize)("editor.domain_media_player"),icon:"mdi:speaker"},{key:"scenes",label:(0,n.localize)("editor.domain_scenes"),icon:"mdi:palette"},{key:"vacuum",label:(0,n.localize)("editor.domain_vacuum"),icon:"mdi:robot-vacuum"},{key:"fan",label:(0,n.localize)("editor.domain_fan"),icon:"mdi:fan"},{key:"switches",label:(0,n.localize)("editor.domain_switches"),icon:"mdi:light-switch"},{key:"locks",label:(0,n.localize)("editor.domain_locks"),icon:"mdi:lock"},{key:"energy",label:(0,n.localize)("stacks.energy"),icon:"mdi:lightning-bolt"}],_=u.some(e=>(i[e.key]?.length??0)>0),g=(o?.length??0)>0||(s?.length??0)>0,m=[],f=new Set,y=e=>{if(!e||f.has(e))return;f.add(e);const t=h.states[e],i=t?.attributes.friendly_name||e.split(".")[1]?.replace(/_/g," ")||e;m.push({entity_id:e,name:i})};for(const e of u)for(const t of i[e.key]||[])y(t);for(const e of o||[])y(e);for(const e of s||[])y(e);for(const e of c||[])y(e.entity_id);m.sort((e,t)=>e.name.localeCompare(t.name));const v=this._renderAreaCustomCardsSection(e,m);if(!_&&!g)return r.qy`
        <div class="empty-state">${(0,n.localize)("editor.no_entities_in_area")}</div>
        ${this._renderStackOrderPanel(e,t)}
        ${v}
      `;const b=this._expandedGroups.get(e)||new Set;return r.qy`
      <div class="entity-groups">
        ${u.map(t=>{const o=i[t.key];if(!o||0===o.length)return r.s6;const s=a[t.key]||[],n=o.every(e=>s.includes(e)),c=o.some(e=>s.includes(e))&&!n,l=b.has(t.key);return r.qy`
            <div class="entity-group" data-group=${t.key}>
              ...
              ${l?r.qy`
                  <div class="entity-list" data-area-id=${e} data-group=${t.key}>
                    ${o.map(i=>{const a=h.states[i],o=a?.attributes.friendly_name||i.split(".")[1].replace(/_/g," "),n=s.includes(i);return r.qy`
          ...
          `})}
        ${g?this._renderBadgeGroup(e,o,s,c,a,l,d,p,b):r.s6}
        ${this._renderStackOrderPanel(e,t)}
      </div>
      ${v}
    `}_renderAreaCustomCardItem(e,t,i,a){const o=t.mode||"yaml",s=t.position||"bottom",c=t._yaml_error?r.qy`<span style="color: var(--error-color);">&#x274C; ${t._yaml_error}</span>`:t.yaml?r.qy`<span style="color: var(--success-color, green);">&#x2705; ${(0,n.localize)("editor.yaml_valid")}</span>`:r.s6;return r.qy`
      <div class="custom-item" data-index=${i}>
        <div class="custom-item-header">
          <strong>${this._getCustomCardEditorLabel(t,(0,n.localize)("editor.area_custom_card_new"))}</strong>
          <button class="btn-remove" @click=${()=>this._removeAreaCustomCard(e,i)}>&#x2715;</button>
        </div>
        <div class="custom-item-fields">
          <label>${(0,n.localize)("editor.card_editor_title_label")}</label>
          <input type="text" .value=${t.editor_title||""} placeholder=${(0,n.localize)("editor.card_editor_title_placeholder")}
            @change=${t=>this._updateAreaCustomCardField(e,i,"editor_title",t.target.value)} />
          <div class="description" style="margin: 0 0 4px 0;">${(0,n.localize)("editor.card_editor_title_help")}</div>
          <label>${(0,n.localize)("editor.card_dashboard_title_label")}</label>
          <input type="text" .value=${t.title||""} placeholder=${(0,n.localize)("editor.card_title_placeholder")}
            @change=${t=>this._updateAreaCustomCardField(e,i,"title",t.target.value)} />
          <div class="custom-card-target">
            <label>${(0,n.localize)("editor.area_custom_card_position")}:</label>
            <select
              @change=${t=>this._updateAreaCustomCardField(e,i,"position",t.target.value)}>
              <option value="top" ?selected=${"top"===s}>${(0,n.localize)("editor.area_custom_card_position_top")}</option>
              <option value="bottom" ?selected=${"bottom"===s}>${(0,n.localize)("editor.area_custom_card_position_bottom")}</option>
            </select>
          </div>
          <div class="custom-card-target">
            <label>${(0,n.localize)("editor.area_custom_card_mode")}:</label>
            <select
              @change=${t=>this._updateAreaCustomCardField(e,i,"mode",t.target.value)}>
              <option value="yaml" ?selected=${"yaml"===o}>${(0,n.localize)("editor.area_custom_card_mode_yaml")}</option>
              <option value="tile" ?selected=${"tile"===o}>${(0,n.localize)("editor.area_custom_card_mode_tile")}</option>
              <option value="section" ?selected=${"section"===o}>${(0,n.localize)("editor.area_custom_card_mode_section")}</option>
            </select>
          </div>
          ${"tile"===o?r.qy`
              <div class="custom-card-target">
                <label>${(0,n.localize)("editor.area_custom_card_entity")}:</label>
                <select
                  @change=${t=>this._updateAreaCustomCardField(e,i,"entity",t.target.value)}>
                  <option value="">${(0,n.localize)("editor.area_custom_card_entity_select")}</option>
                  ${a.map(e=>r.qy`
    ...
    `}_renderAreaCustomCardsSection(e,t){const i=this._getAreaCustomCards(e);return r.qy`
      <div class="area-custom-cards">
        <div class="area-custom-cards-header">
          ...
          <span class="group-name">${(0,n.localize)("editor.area_custom_cards_title")}</span>
        </div>
        <div class="area-custom-cards-help">${(0,n.localize)("editor.area_custom_cards_help")}</div>
        ...
        <div class="area-custom-card-actions">
          <button class="btn-primary" @click=${()=>this._addAreaCustomCard(e)}>
            ${(0,n.localize)("editor.area_custom_card_add_yaml")}
          </button>
          <button class="btn-primary" @click=${()=>this._openCardPickerForAreaCustomCard(e)}>
            ${(0,n.localize)("editor.area_custom_card_add_picker")}
          </button>
        </div>
      </div>
    `}_renderBadgeGroup(e,t,i,a,o,s,l,d,p){const h=this._hass,u=t.length+i.length;if(0===u)return r.qy``;const _=o.badges||[],g=t.length>0&&t.every(e=>_.includes(e)),m=t.some(e=>_.includes(e))&&!g,f=new Set(l||[]),y=new Set(d||[]),v=e=>(0,c.LN)(e,s.has(e),f,y),b=p.has("badges");return r.qy`
      <div class="entity-group" data-group="badges">
        <div class="entity-group-header"
          ...
          <span class="group-name">${(0,n.localize)("editor.domain_badges")}</span>
        ...
        ${b?r.qy`
            <div class="entity-list" data-area-id=${e} data-group="badges">
              ${t.map(t=>{const i=h.states[t],a=i?.attributes.friendly_name||t.split(".")[1].replace(/_/g," "),o=_.includes(t),s=v(t);return r.qy`
                  <div class="entity-item">
                    <input type="checkbox" class="entity-checkbox"
                      ?checked=${!o}
                    ...
                    <input type="checkbox" class="badge-name-checkbox"
                      ?checked=${s}
                      title=${(0,n.localize)("editor.badges_show_name")}
                      @change=${i=>this._badgeShowNameChanged(e,t,i.target.checked)} />
                    <span class="badge-name-label">${(0,n.localize)("editor.badges_name_short")}</span>
                    <span class="entity-id">${t}</span>
                  </div>
                `})}

              ${i.length>0?r.qy`
                  <div class="badge-separator">${(0,n.localize)("editor.badges_additional")}</div>
                  ${i.map(t=>{const i=h.states[t],a=i?.attributes.friendly_name||t.split(".")[1].replace(/_/g," "),o=v(t);return r.qy`
                      <div class="entity-item badge-additional-item">
                        ...
                        <button class="badge-remove-btn"
                          title=${(0,n.localize)("editor.badges_remove")}
              ...
              ${a.length>0?r.qy`
                  <div class="badge-add-section">
                    <select class="badge-entity-picker" data-area-id=${e}>
                      <option value="">${(0,n.localize)("editor.badges_select_entity")}</option>
                      ${a.map(e=>r.qy`
                    ...
                    <button class="badge-add-button"
                      ...
                      ${(0,n.localize)("editor.badges_add")}
                    </button>
                  </div>
                `:r.s6}
            </div>
    ...
    `}_renderCardEditor(){const e=h.find(e=>e.type===this._cardPickerSelectedType)?.name||this._cardPickerSelectedType;return r.qy`
      <div class="card-picker-overlay" @click=${this._handlePickerOverlayClick}>
        <div class="card-picker-dialog" @click=${e=>e.stopPropagation()}>
          <div class="card-picker-header">
    ...
    `}}function _(e,t){const i=Object.values(t.devices||{}),r=Object.values(t.entities||{}),a=new Set;for(const t of i)t.area_id===e&&a.add(t.id);const o=[];for(const i of r){let r=!1;if(i.area_id?r=i.area_id===e:i.device_id&&a.has(i.device_id)&&(r=!0),!r)continue;if(i.hidden)continue;if(i.labels?.includes("no_dboard"))continue;if(!t.states[i.entity_id])continue;const s=i.entity_id.split(".")[0],n=t.states[i.entity_id],l=n.attributes?.device_class,d=n.attributes?.unit_of_measurement;if((0,c.fF)(s,l,d,i.entity_id)){if("sensor"===s&&("battery"===l||i.entity_id.includes("battery"))){const e=parseFloat(n.state);!isNaN(e)&&e<20&&o.push(i.entity_id);continue}o.push(i.entity_id)}}return o}function g(e,t){return t.areas_options?.[e]?.groups_options?.badges?.additional||[]}function m(e,t,i,r){const a=Object.values(t.devices||{}),o=Object.values(t.entities||{}),s=new Set([...i,...r]),n=new Set;for(const t of a)t.area_id===e&&n.add(t.id);const c=[];for(const i of o){let r=!1;if(i.area_id?r=i.area_id===e:i.device_id&&n.has(i.device_id)&&(r=!0),!r)continue;if(i.hidden)continue;if(!t.states[i.entity_id])continue;const a=i.entity_id.split(".")[0];if("sensor"!==a&&"binary_sensor"!==a)continue;if(s.has(i.entity_id))continue;const o=t.states[i.entity_id],l=o.attributes?.friendly_name||i.entity_id.split(".")[1].replace(/_/g," ");c.push({entity_id:i.entity_id,name:l})}return c.sort((e,t)=>e.name.localeCompare(t.name)),c}function f(e,t){const i=new Set;for(const r of e){const e=t.states[r];if(!e)continue;const a=e.attributes?.device_class;(0,c.g7)(a)&&i.add(r)}return i}function y(e,t){const i=t.areas_options?.[e]?.groups_options?.badges;return{namesVisible:i?.names_visible||[],namesHidden:i?.names_hidden||[]}}function v(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.hidden&&(r[e]=t.hidden);return r}function b(e,t){const i=t.areas_options?.[e];if(!i||!i.groups_options)return{};const r={};for(const[e,t]of Object.entries(i.groups_options))t.order&&(r[e]=t.order);return r}u.properties={_config:{state:!0},_expandedAreas:{state:!0},_expandedGroups:{state:!0},_expandedWeatherBlocks:{state:!0},_cardPickerOpen:{state:!0},_cardPickerStep:{state:!0},_cardPickerSearch:{state:!0},_cardPickerSelectedType:{state:!0},_cardPickerYaml:{state:!0},_cardPickerHasVisualEditor:{state:!0}},u.styles=r.AH`
    /* -- Base layout --------------------------------------------------- */
    .card-config {
      padding: 16px;
  ...
  `,u._sectionMeta=new Map([["overview",{icon:"mdi:home-outline",labelKey:"sections.overview"}],["custom_cards",{icon:"mdi:cards",labelKey:"sections.custom_cards"}],["custom_sections",{icon:"mdi:view-grid-plus-outline",labelKey:"sections.custom_sections"}],["areas",{icon:"mdi:floor-plan",labelKey:"sections.areas"}],["weather",{icon:"mdi:weather-partly-cloudy",labelKey:"sections.weather"}],["energy",{icon:"mdi:lightning-bolt",labelKey:"sections.energy"}]]),u._weatherStartBlockMeta=new Map([["clock",{icon:"mdi:clock-outline",labelKey:"weather_start_blocks.clock"}],["date",{icon:"mdi:calendar-today",labelKey:"weather_start_blocks.date"}],["summaries",{icon:"mdi:view-dashboard-outline",labelKey:"weather_start_blocks.summaries"}],["weather_current",{icon:"mdi:weather-partly-cloudy",labelKey:"weather_start_blocks.weather_current"}],["weather_hourly",{icon:"mdi:clock-time-four-outline",labelKey:"weather_start_blocks.weather_hourly"}],["weather_daily",{icon:"mdi:calendar-week",labelKey:"weather_start_blocks.weather_daily"}],["areas",{icon:"mdi:floor-plan",labelKey:"weather_start_blocks.areas"}],["custom_cards",{icon:"mdi:cards",labelKey:"weather_start_blocks.custom_cards"}],["custom_sections",{icon:"mdi:view-grid-plus-outline",labelKey:"weather_start_blocks.custom_sections"}]]),u._stackMeta=new Map([["energy",{icon:"mdi:lightning-bolt",labelKey:"stacks.energy"}],["cameras",{icon:"mdi:cctv",labelKey:"stacks.cameras"}],["lights",{icon:"mdi:lightbulb",labelKey:"stacks.lights"}],["locks",{icon:"mdi:lock",labelKey:"stacks.locks"}],["climate",{icon:"mdi:thermostat",labelKey:"stacks.climate"}],["covers",{icon:"mdi:window-shutter",labelKey:"stacks.covers"}],["covers_window",{icon:"mdi:window-open-variant",labelKey:"stacks.covers_window"}],["media",{icon:"mdi:speaker",labelKey:"stacks.media"}],["scenes",{icon:"mdi:palette",labelKey:"stacks.scenes"}],["misc",{icon:"mdi:light-switch",labelKey:"stacks.misc"}],["room_pins",{icon:"mdi:pin",labelKey:"stacks.room_pins"}]]),customElements.define("dashboard-strategy-editor",u)},382(e,t,i){i.d(t,{Ay:()=>Z});var r=Object.create,a=Object.defineProperty,o=Object.getOwnPropertyDescriptor,s=Object.getOwnPropertyNames,n=Object.getPrototypeOf,c=Object.prototype.hasOwnProperty,l=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),d=(e,t,i)=>(i=null!=e?r(n(e)):{},((e,t,i,r)=>{if(t&&"object"==typeof t||"function"==typeof t)for(var n,l=s(t),d=0,p=l.length;d<p;d++)n=l[d],c.call(e,n)||void 0===n||a(e,n,{get:(e=>t[e]).bind(null,n),enumerable:!(r=o(t,n))||r.enumerable});return e})(!t&&e&&e.__esModule?i:a(i,"default",{value:e,enumerable:!0}),e)),p=l((e,t)=>{function i(e){return null==e}t.exports.isNothing=i,t.exports.isObject=function(e){return"object"==typeof e&&null!==e},t.exports.toArray=function(e){return Array.isArray(e)?e:i(e)?[]:[e]},t.exports.repeat=function(e,t){let i="";for(let r=0;r<t;r+=1)i+=e;return i},t.exports.isNegativeZero=function(e){return 0===e&&Number.NEGATIVE_INFINITY===1/e},t.exports.extend=function(e,t){if(t){const i=Object.keys(t);for(let r=0,a=i.length;r<a;r+=1){const a=i[r];e[a]=t[a]}}return e}}),h=l((e,t)=>{function i(e,t){let i="";const r=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(i+='in "'+e.mark.name+'" '),i+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!t&&e.mark.snippet&&(i+="\n\n"+e.mark.snippet),r+" "+i):r}function r(e,t){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=t,this.message=i(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=(new Error).stack||""}r.prototype=Object.create(Error.prototype),r.prototype.constructor=r,r.prototype.toString=function(e){return this.name+": "+i(this,e)},t.exports=r}),u=l((e,t)=>{var i=p();function r(e,t,i,r,a){let o="",s="";const n=Math.floor(a/2)-1;return r-t>n&&(o=" ... ",t=r-n+o.length),i-r>n&&(s=" ...",i=r+n-s.length),{str:o+e.slice(t,i).replace(/\t/g,"→")+s,pos:r-t+o.length}}function a(e,t){return i.repeat(" ",t-e.length)+e}t.exports=function(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||(t.maxLength=79),"number"!=typeof t.indent&&(t.indent=1),"number"!=typeof t.linesBefore&&(t.linesBefore=3),"number"!=typeof t.linesAfter&&(t.linesAfter=2);const o=/\r?\n|\r|\0/g,s=[0],n=[];let c,l=-1;for(;c=o.exec(e.buffer);)n.push(c.index),s.push(c.index+c[0].length),e.position<=c.index&&l<0&&(l=s.length-2);l<0&&(l=s.length-1);let d="";const p=Math.min(e.line+t.linesAfter,n.length).toString().length,h=t.maxLength-(t.indent+p+3);for(let o=1;o<=t.linesBefore&&!(l-o<0);o++){const c=r(e.buffer,s[l-o],n[l-o],e.position-(s[l]-s[l-o]),h);d=i.repeat(" ",t.indent)+a((e.line-o+1).toString(),p)+" | "+c.str+"\n"+d}const u=r(e.buffer,s[l],n[l],e.position,h);d+=i.repeat(" ",t.indent)+a((e.line+1).toString(),p)+" | "+u.str+"\n",d+=i.repeat("-",t.indent+p+3+u.pos)+"^\n";for(let o=1;o<=t.linesAfter&&!(l+o>=n.length);o++){const c=r(e.buffer,s[l+o],n[l+o],e.position-(s[l]-s[l+o]),h);d+=i.repeat(" ",t.indent)+a((e.line+o+1).toString(),p)+" | "+c.str+"\n"}return d.replace(/\n$/,"")}}),_=l((e,t)=>{var i=h(),r=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],a=["scalar","sequence","mapping"];t.exports=function(e,t){if(t=t||{},Object.keys(t).forEach(function(t){if(-1===r.indexOf(t))throw new i('Unknown option "'+t+'" is met in definition of "'+e+'" YAML type.')}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(e){return e},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=function(e){const t={};return null!==e&&Object.keys(e).forEach(function(i){e[i].forEach(function(e){t[String(e)]=i})}),t}(t.styleAliases||null),-1===a.indexOf(this.kind))throw new i('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}}),g=l((e,t)=>{var i=h(),r=_();function a(e,t){const i=[];return e[t].forEach(function(e){let t=i.length;i.forEach(function(i,r){i.tag===e.tag&&i.kind===e.kind&&i.multi===e.multi&&(t=r)}),i[t]=e}),i}function o(e){return this.extend(e)}o.prototype.extend=function(e){let t=[],s=[];if(e instanceof r)s.push(e);else if(Array.isArray(e))s=s.concat(e);else{if(!e||!Array.isArray(e.implicit)&&!Array.isArray(e.explicit))throw new i("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(s=s.concat(e.explicit))}t.forEach(function(e){if(!(e instanceof r))throw new i("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(e.loadKind&&"scalar"!==e.loadKind)throw new i("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(e.multi)throw new i("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),s.forEach(function(e){if(!(e instanceof r))throw new i("Specified list of YAML types (or a single Type object) contains a non-Type object.")});const n=Object.create(o.prototype);return n.implicit=(this.implicit||[]).concat(t),n.explicit=(this.explicit||[]).concat(s),n.compiledImplicit=a(n,"implicit"),n.compiledExplicit=a(n,"explicit"),n.compiledTypeMap=function(){const e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}};function t(t){t.multi?(e.multi[t.kind].push(t),e.multi.fallback.push(t)):e[t.kind][t.tag]=e.fallback[t.tag]=t}for(let e=0,i=arguments.length;e<i;e+=1)arguments[e].forEach(t);return e}(n.compiledImplicit,n.compiledExplicit),n},t.exports=o}),m=l((e,t)=>{t.exports=new(_())("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return null!==e?e:""}})}),f=l((e,t)=>{t.exports=new(_())("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return null!==e?e:[]}})}),y=l((e,t)=>{t.exports=new(_())("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return null!==e?e:{}}})}),v=l((e,t)=>{t.exports=new(g())({explicit:[m(),f(),y()]})}),b=l((e,t)=>{var i=_();t.exports=new i("tag:yaml.org,2002:null",{kind:"scalar",resolve:function(e){if(null===e)return!0;const t=e.length;return 1===t&&"~"===e||4===t&&("null"===e||"Null"===e||"NULL"===e)},construct:function(){return null},predicate:function(e){return null===e},represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"})}),x=l((e,t)=>{var i=_();t.exports=new i("tag:yaml.org,2002:bool",{kind:"scalar",resolve:function(e){if(null===e)return!1;const t=e.length;return 4===t&&("true"===e||"True"===e||"TRUE"===e)||5===t&&("false"===e||"False"===e||"FALSE"===e)},construct:function(e){return"true"===e||"True"===e||"TRUE"===e},predicate:function(e){return"[object Boolean]"===Object.prototype.toString.call(e)},represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"})}),w=l((e,t)=>{var i=p(),r=_();function a(e){return e>=48&&e<=57||e>=65&&e<=70||e>=97&&e<=102}function o(e){return e>=48&&e<=55}function s(e){return e>=48&&e<=57}function n(e){let t=e,i=1,r=t[0];if("-"!==r&&"+"!==r||("-"===r&&(i=-1),t=t.slice(1),r=t[0]),"0"===t)return 0;if("0"===r){if("b"===t[1])return i*parseInt(t.slice(2),2);if("x"===t[1])return i*parseInt(t.slice(2),16);if("o"===t[1])return i*parseInt(t.slice(2),8)}return i*parseInt(t,10)}t.exports=new r("tag:yaml.org,2002:int",{kind:"scalar",resolve:function(e){if(null===e)return!1;const t=e.length;let i=0,r=!1;if(!t)return!1;let c=e[i];if("-"!==c&&"+"!==c||(c=e[++i]),"0"===c){if(i+1===t)return!0;if(c=e[++i],"b"===c){for(i++;i<t;i++){if(c=e[i],"0"!==c&&"1"!==c)return!1;r=!0}return r&&Number.isFinite(n(e))}if("x"===c){for(i++;i<t;i++){if(!a(e.charCodeAt(i)))return!1;r=!0}return r&&Number.isFinite(n(e))}if("o"===c){for(i++;i<t;i++){if(!o(e.charCodeAt(i)))return!1;r=!0}return r&&Number.isFinite(n(e))}}for(;i<t;i++){if(!s(e.charCodeAt(i)))return!1;r=!0}return!!r&&Number.isFinite(n(e))},construct:function(e){return n(e)},predicate:function(e){return"[object Number]"===Object.prototype.toString.call(e)&&e%1==0&&!i.isNegativeZero(e)},represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}})}),C=l((e,t)=>{var i=p(),r=_(),a=new RegExp("^(?:[-+]?(?:[0-9]+)(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"),o=new RegExp("^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"),s=/^[-+]?[0-9]+e/;t.exports=new r("tag:yaml.org,2002:float",{kind:"scalar",resolve:function(e){return null!==e&&!!a.test(e)&&(!!Number.isFinite(parseFloat(e,10))||o.test(e))},construct:function(e){let t=e.toLowerCase();const i="-"===t[0]?-1:1;return"+-".indexOf(t[0])>=0&&(t=t.slice(1)),".inf"===t?1===i?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:".nan"===t?NaN:i*parseFloat(t,10)},predicate:function(e){return"[object Number]"===Object.prototype.toString.call(e)&&(e%1!=0||i.isNegativeZero(e))},represent:function(e,t){if(isNaN(e))switch(t){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(t){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(t){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(i.isNegativeZero(e))return"-0.0";const r=e.toString(10);return s.test(r)?r.replace("e",".e"):r},defaultStyle:"lowercase"})}),k=l((e,t)=>{t.exports=v().extend({implicit:[b(),x(),w(),C()]})}),$=l((e,t)=>{t.exports=k()}),S=l((e,t)=>{var i=_(),r=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),a=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");t.exports=new i("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:function(e){return null!==e&&(null!==r.exec(e)||null!==a.exec(e))},construct:function(e){let t=0,i=null,o=r.exec(e);if(null===o&&(o=a.exec(e)),null===o)throw new Error("Date resolve error");const s=+o[1],n=+o[2]-1,c=+o[3];if(!o[4])return new Date(Date.UTC(s,n,c));const l=+o[4],d=+o[5],p=+o[6];if(o[7]){for(t=o[7].slice(0,3);t.length<3;)t+="0";t=+t}o[9]&&(i=6e4*(60*+o[10]+ +(o[11]||0)),"-"===o[9]&&(i=-i));const h=new Date(Date.UTC(s,n,c,l,d,p,t));return i&&h.setTime(h.getTime()-i),h},instanceOf:Date,represent:function(e){return e.toISOString()}})}),z=l((e,t)=>{var i=_();t.exports=new i("tag:yaml.org,2002:merge",{kind:"scalar",resolve:function(e){return"<<"===e||null===e}})}),A=l((e,t)=>{var i=_(),r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r";t.exports=new i("tag:yaml.org,2002:binary",{kind:"scalar",resolve:function(e){if(null===e)return!1;let t=0;const i=e.length,a=r;for(let r=0;r<i;r++){const i=a.indexOf(e.charAt(r));if(!(i>64)){if(i<0)return!1;t+=6}}return t%8==0},construct:function(e){const t=e.replace(/[\r\n=]/g,""),i=t.length,a=r;let o=0;const s=[];for(let e=0;e<i;e++)e%4==0&&e&&(s.push(o>>16&255),s.push(o>>8&255),s.push(255&o)),o=o<<6|a.indexOf(t.charAt(e));const n=i%4*6;return 0===n?(s.push(o>>16&255),s.push(o>>8&255),s.push(255&o)):18===n?(s.push(o>>10&255),s.push(o>>2&255)):12===n&&s.push(o>>4&255),new Uint8Array(s)},predicate:function(e){return"[object Uint8Array]"===Object.prototype.toString.call(e)},represent:function(e){let t="",i=0;const a=e.length,o=r;for(let r=0;r<a;r++)r%3==0&&r&&(t+=o[i>>18&63],t+=o[i>>12&63],t+=o[i>>6&63],t+=o[63&i]),i=(i<<8)+e[r];const s=a%3;return 0===s?(t+=o[i>>18&63],t+=o[i>>12&63],t+=o[i>>6&63],t+=o[63&i]):2===s?(t+=o[i>>10&63],t+=o[i>>4&63],t+=o[i<<2&63],t+=o[64]):1===s&&(t+=o[i>>2&63],t+=o[i<<4&63],t+=o[64],t+=o[64]),t}})}),O=l((e,t)=>{var i=_(),r=Object.prototype.hasOwnProperty,a=Object.prototype.toString;t.exports=new i("tag:yaml.org,2002:omap",{kind:"sequence",resolve:function(e){if(null===e)return!0;const t=[],i=e;for(let e=0,o=i.length;e<o;e+=1){const o=i[e];let s,n=!1;if("[object Object]"!==a.call(o))return!1;for(s in o)if(r.call(o,s)){if(n)return!1;n=!0}if(!n)return!1;if(-1!==t.indexOf(s))return!1;t.push(s)}return!0},construct:function(e){return null!==e?e:[]}})}),E=l((e,t)=>{var i=_(),r=Object.prototype.toString;t.exports=new i("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:function(e){if(null===e)return!0;const t=e,i=new Array(t.length);for(let e=0,a=t.length;e<a;e+=1){const a=t[e];if("[object Object]"!==r.call(a))return!1;const o=Object.keys(a);if(1!==o.length)return!1;i[e]=[o[0],a[o[0]]]}return!0},construct:function(e){if(null===e)return[];const t=e,i=new Array(t.length);for(let e=0,r=t.length;e<r;e+=1){const r=t[e],a=Object.keys(r);i[e]=[a[0],r[a[0]]]}return i}})}),I=l((e,t)=>{var i=_(),r=Object.prototype.hasOwnProperty;t.exports=new i("tag:yaml.org,2002:set",{kind:"mapping",resolve:function(e){if(null===e)return!0;const t=e;for(const e in t)if(r.call(t,e)&&null!==t[e])return!1;return!0},construct:function(e){return null!==e?e:{}}})}),L=l((e,t)=>{t.exports=$().extend({implicit:[S(),z()],explicit:[A(),O(),E(),I()]})}),q=l((e,t)=>{var i=p(),r=h(),a=u(),o=L(),s=Object.prototype.hasOwnProperty,n=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,c=/[\x85\u2028\u2029]/,l=/[,\[\]{}]/,d=/^(?:!|!!|![0-9A-Za-z-]+!)$/,_=/^(?:!|[^,\[\]{}])(?:%[0-9a-f]{2}|[0-9a-z\-#;/?:@&=+$,_.!~*'()\[\]])*$/i;function g(e){return Object.prototype.toString.call(e)}function m(e){return 10===e||13===e}function f(e){return 9===e||32===e}function y(e){return 9===e||32===e||10===e||13===e}function v(e){return 44===e||91===e||93===e||123===e||125===e}function b(e){if(e>=48&&e<=57)return e-48;const t=32|e;return t>=97&&t<=102?t-97+10:-1}function x(e){return 120===e?2:117===e?4:85===e?8:0}function w(e){return e>=48&&e<=57?e-48:-1}function C(e){switch(e){case 48:return"\0";case 97:return"";case 98:return"\b";case 116:case 9:return"\t";case 110:return"\n";case 118:return"\v";case 102:return"\f";case 114:return"\r";case 101:return"";case 32:return" ";case 34:return'"';case 47:return"/";case 92:return"\\";case 78:return"";case 95:return" ";case 76:return"\u2028";case 80:return"\u2029";default:return""}}function k(e){return e<=65535?String.fromCharCode(e):String.fromCharCode(55296+(e-65536>>10),56320+(e-65536&1023))}function $(e,t,i){"__proto__"===t?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:i}):e[t]=i}var S=new Array(256),z=new Array(256);for(let e=0;e<256;e++)S[e]=C(e)?1:0,z[e]=C(e);function A(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||o,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.maxDepth="number"==typeof t.maxDepth?t.maxDepth:100,this.maxMergeSeqLength="number"==typeof t.maxMergeSeqLength?t.maxMergeSeqLength:20,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.depth=0,this.firstTabInLine=-1,this.documents=[],this.anchorMapTransactions=[]}function O(e,t){const i={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return i.snippet=a(i),new r(t,i)}function E(e,t){throw O(e,t)}function I(e,t){e.onWarning&&e.onWarning.call(null,O(e,t))}function q(e,t,i){const r=e.anchorMapTransactions;if(0!==r.length){const i=r[r.length-1];s.call(i,t)||(i[t]={existed:s.call(e.anchorMap,t),value:e.anchorMap[t]})}e.anchorMap[t]=i}function j(e){return{position:e.position,line:e.line,lineStart:e.lineStart,lineIndent:e.lineIndent,firstTabInLine:e.firstTabInLine,tag:e.tag,anchor:e.anchor,kind:e.kind,result:e.result}}function D(e,t){e.position=t.position,e.line=t.line,e.lineStart=t.lineStart,e.lineIndent=t.lineIndent,e.firstTabInLine=t.firstTabInLine,e.tag=t.tag,e.anchor=t.anchor,e.kind=t.kind,e.result=t.result}var P={YAML:function(e,t,i){null!==e.version&&E(e,"duplication of %YAML directive"),1!==i.length&&E(e,"YAML directive accepts exactly one argument");const r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]);null===r&&E(e,"ill-formed argument of the YAML directive");const a=parseInt(r[1],10),o=parseInt(r[2],10);1!==a&&E(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=o<2,1!==o&&2!==o&&I(e,"unsupported YAML version of the document")},TAG:function(e,t,i){let r;2!==i.length&&E(e,"TAG directive accepts exactly two arguments");const a=i[0];r=i[1],d.test(a)||E(e,"ill-formed tag handle (first argument) of the TAG directive"),s.call(e.tagMap,a)&&E(e,'there is a previously declared suffix for "'+a+'" tag handle'),_.test(r)||E(e,"ill-formed tag prefix (second argument) of the TAG directive");try{r=decodeURIComponent(r)}catch(t){E(e,"tag prefix is malformed: "+r)}e.tagMap[a]=r}};function F(e,t,i,r){if(t<i){const a=e.input.slice(t,i);if(r)for(let t=0,i=a.length;t<i;t+=1){const i=a.charCodeAt(t);9===i||i>=32&&i<=1114111||E(e,"expected valid JSON character")}else n.test(a)&&E(e,"the stream contains non-printable characters");e.result+=a}}function T(e,t,r,a){i.isObject(r)||E(e,"cannot merge mappings; the provided source object is unacceptable");const o=Object.keys(r);for(let e=0,i=o.length;e<i;e+=1){const i=o[e];s.call(t,i)||($(t,i,r[i]),a[i]=!0)}}function W(e,t,i,r,a,o,n,c,l){if(Array.isArray(a))for(let t=0,i=(a=Array.prototype.slice.call(a)).length;t<i;t+=1)Array.isArray(a[t])&&E(e,"nested arrays are not supported inside keys"),"object"==typeof a&&"[object Object]"===g(a[t])&&(a[t]="[object Object]");if("object"==typeof a&&"[object Object]"===g(a)&&(a="[object Object]"),a=String(a),null===t&&(t={}),"tag:yaml.org,2002:merge"===r)if(Array.isArray(o)){o.length>e.maxMergeSeqLength&&E(e,"merge sequence length exceeded maxMergeSeqLength ("+e.maxMergeSeqLength+")");const r=new Set;for(let a=0,s=o.length;a<s;a+=1){const s=o[a];r.has(s)||(r.add(s),T(e,t,s,i))}}else T(e,t,o,i);else e.json||s.call(i,a)||!s.call(t,a)||(e.line=n||e.line,e.lineStart=c||e.lineStart,e.position=l||e.position,E(e,"duplicated mapping key")),$(t,a,o),delete i[a];return t}function M(e){const t=e.input.charCodeAt(e.position);10===t?e.position++:13===t?(e.position++,10===e.input.charCodeAt(e.position)&&e.position++):E(e,"a line break is expected"),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function N(e,t,i){let r=0,a=e.input.charCodeAt(e.position);for(;0!==a;){for(;f(a);)9===a&&-1===e.firstTabInLine&&(e.firstTabInLine=e.position),a=e.input.charCodeAt(++e.position);if(t&&35===a)do{a=e.input.charCodeAt(++e.position)}while(10!==a&&13!==a&&0!==a);if(!m(a))break;for(M(e),a=e.input.charCodeAt(e.position),r++,e.lineIndent=0;32===a;)e.lineIndent++,a=e.input.charCodeAt(++e.position)}return-1!==i&&0!==r&&e.lineIndent<i&&I(e,"deficient indentation"),r}function Y(e){let t=e.position,i=e.input.charCodeAt(t);return!(45!==i&&46!==i||i!==e.input.charCodeAt(t+1)||i!==e.input.charCodeAt(t+2)||(t+=3,i=e.input.charCodeAt(t),0!==i&&!y(i)))}function B(e,t){1===t?e.result+=" ":t>1&&(e.result+=i.repeat("\n",t-1))}function K(e,t){const i=e.tag,r=e.anchor,a=[];let o=!1;if(-1!==e.firstTabInLine)return!1;null!==e.anchor&&q(e,e.anchor,a);let s=e.input.charCodeAt(e.position);for(;0!==s&&(-1!==e.firstTabInLine&&(e.position=e.firstTabInLine,E(e,"tab characters must not be used in indentation")),45===s)&&y(e.input.charCodeAt(e.position+1));){if(o=!0,e.position++,N(e,!0,-1)&&e.lineIndent<=t){a.push(null),s=e.input.charCodeAt(e.position);continue}const i=e.line;if(H(e,t,3,!1,!0),a.push(e.result),N(e,!0,-1),s=e.input.charCodeAt(e.position),(e.line===i||e.lineIndent>t)&&0!==s)E(e,"bad indentation of a sequence entry");else if(e.lineIndent<t)break}return!!o&&(e.tag=i,e.anchor=r,e.kind="sequence",e.result=a,!0)}function R(e,t,i){let r,a,o,s;const n=e.tag,c=e.anchor,l={},d=Object.create(null);let p=null,h=null,u=null,_=!1,g=!1;if(-1!==e.firstTabInLine)return!1;null!==e.anchor&&q(e,e.anchor,l);let m=e.input.charCodeAt(e.position);for(;0!==m;){_||-1===e.firstTabInLine||(e.position=e.firstTabInLine,E(e,"tab characters must not be used in indentation"));const v=e.input.charCodeAt(e.position+1),b=e.line;if(63!==m&&58!==m||!y(v)){if(a=e.line,o=e.lineStart,s=e.position,!H(e,i,2,!1,!0))break;if(e.line===b){for(m=e.input.charCodeAt(e.position);f(m);)m=e.input.charCodeAt(++e.position);if(58===m)m=e.input.charCodeAt(++e.position),y(m)||E(e,"a whitespace character is expected after the key-value separator within a block mapping"),_&&(W(e,l,d,p,h,null,a,o,s),p=h=u=null),g=!0,_=!1,r=!1,p=e.tag,h=e.result;else{if(!g)return e.tag=n,e.anchor=c,!0;E(e,"can not read an implicit mapping pair; a colon is missed")}}else{if(!g)return e.tag=n,e.anchor=c,!0;E(e,"can not read a block mapping entry; a multiline key may not be an implicit key")}}else 63===m?(_&&(W(e,l,d,p,h,null,a,o,s),p=h=u=null),g=!0,_=!0,r=!0):_?(_=!1,r=!0):E(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,m=v;if((e.line===b||e.lineIndent>t)&&(_&&(a=e.line,o=e.lineStart,s=e.position),H(e,t,4,!0,r)&&(_?h=e.result:u=e.result),_||(W(e,l,d,p,h,u,a,o,s),p=h=u=null),N(e,!0,-1),m=e.input.charCodeAt(e.position)),(e.line===b||e.lineIndent>t)&&0!==m)E(e,"bad indentation of a mapping entry");else if(e.lineIndent<t)break}return _&&W(e,l,d,p,h,null,a,o,s),g&&(e.tag=n,e.anchor=c,e.kind="mapping",e.result=l),g}function V(e){let t,i,r=!1,a=!1,o=e.input.charCodeAt(e.position);if(33!==o)return!1;null!==e.tag&&E(e,"duplication of a tag property"),o=e.input.charCodeAt(++e.position),60===o?(r=!0,o=e.input.charCodeAt(++e.position)):33===o?(a=!0,t="!!",o=e.input.charCodeAt(++e.position)):t="!";let n=e.position;if(r){do{o=e.input.charCodeAt(++e.position)}while(0!==o&&62!==o);e.position<e.length?(i=e.input.slice(n,e.position),o=e.input.charCodeAt(++e.position)):E(e,"unexpected end of the stream within a verbatim tag")}else{for(;0!==o&&!y(o);)33===o&&(a?E(e,"tag suffix cannot contain exclamation marks"):(t=e.input.slice(n-1,e.position+1),d.test(t)||E(e,"named tag handle cannot contain such characters"),a=!0,n=e.position+1)),o=e.input.charCodeAt(++e.position);i=e.input.slice(n,e.position),l.test(i)&&E(e,"tag suffix cannot contain flow indicator characters")}i&&!_.test(i)&&E(e,"tag name cannot contain such characters: "+i);try{i=decodeURIComponent(i)}catch(t){E(e,"tag name is malformed: "+i)}return r?e.tag=i:s.call(e.tagMap,t)?e.tag=e.tagMap[t]+i:"!"===t?e.tag="!"+i:"!!"===t?e.tag="tag:yaml.org,2002:"+i:E(e,'undeclared tag handle "'+t+'"'),!0}function U(e){let t=e.input.charCodeAt(e.position);if(38!==t)return!1;null!==e.anchor&&E(e,"duplication of an anchor property"),t=e.input.charCodeAt(++e.position);const i=e.position;for(;0!==t&&!y(t)&&!v(t);)t=e.input.charCodeAt(++e.position);return e.position===i&&E(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(i,e.position),!0}function H(e,t,r,a,o){let n,c,l,d,p,h=1,u=!1,_=!1,g=null;e.depth>=e.maxDepth&&E(e,"nesting exceeded maxDepth ("+e.maxDepth+")"),e.depth+=1,null!==e.listener&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null;const C=n=c=4===r||3===r;if(a&&N(e,!0,-1)&&(u=!0,e.lineIndent>t?h=1:e.lineIndent===t?h=0:e.lineIndent<t&&(h=-1)),1===h)for(;;){const i=e.input.charCodeAt(e.position),r=j(e);if(u&&(33===i&&null!==e.tag||38===i&&null!==e.anchor))break;if(!V(e)&&!U(e))break;null===g&&(g=r),N(e,!0,-1)?(u=!0,c=C,e.lineIndent>t?h=1:e.lineIndent===t?h=0:e.lineIndent<t&&(h=-1)):c=!1}if(c&&(c=u||o),1===h||4===r)if(d=1===r||2===r?t:t+1,p=e.position-e.lineStart,1===h)if(c&&(K(e,p)||R(e,p,d))||function(e,t){let i,r,a,o=!0;const s=e.tag;let n;const c=e.anchor;let l,d,p,h;const u=Object.create(null);let _,g,m,f=e.input.charCodeAt(e.position);if(91===f)l=93,h=!1,n=[];else{if(123!==f)return!1;l=125,h=!0,n={}}for(null!==e.anchor&&q(e,e.anchor,n),f=e.input.charCodeAt(++e.position);0!==f;){if(N(e,!0,t),f=e.input.charCodeAt(e.position),f===l)return e.position++,e.tag=s,e.anchor=c,e.kind=h?"mapping":"sequence",e.result=n,!0;o?44===f&&E(e,"expected the node content, but found ','"):E(e,"missed comma between flow collection entries"),g=_=m=null,d=p=!1,63===f&&y(e.input.charCodeAt(e.position+1))&&(d=p=!0,e.position++,N(e,!0,t)),i=e.line,r=e.lineStart,a=e.position,H(e,t,1,!1,!0),g=e.tag,_=e.result,N(e,!0,t),f=e.input.charCodeAt(e.position),!p&&e.line!==i||58!==f||(d=!0,f=e.input.charCodeAt(++e.position),N(e,!0,t),H(e,t,1,!1,!0),m=e.result),h?W(e,n,u,g,_,m,i,r,a):d?n.push(W(e,null,u,g,_,m,i,r,a)):n.push(_),N(e,!0,t),f=e.input.charCodeAt(e.position),44===f?(o=!0,f=e.input.charCodeAt(++e.position)):o=!1}E(e,"unexpected end of the stream within a flow collection")}(e,d))_=!0;else{const t=e.input.charCodeAt(e.position);null!==g&&C&&!c&&124!==t&&62!==t&&function(e,t,i,r){const a=j(e);return function(e){e.anchorMapTransactions.push(Object.create(null))}(e),D(e,t),e.tag=null,e.anchor=null,e.kind=null,e.result=null,R(e,i,r)&&"mapping"===e.kind?(function(e){const t=e.anchorMapTransactions.pop(),i=e.anchorMapTransactions;if(0===i.length)return;const r=i[i.length-1],a=Object.keys(t);for(let e=0,i=a.length;e<i;e+=1){const i=a[e];s.call(r,i)||(r[i]=t[i])}}(e),!0):(function(e){const t=e.anchorMapTransactions.pop(),i=Object.keys(t);for(let r=i.length-1;r>=0;r-=1){const a=t[i[r]];a.existed?e.anchorMap[i[r]]=a.value:delete e.anchorMap[i[r]]}}(e),D(e,a),!1)}(e,g,g.position-g.lineStart,d)||n&&function(e,t){let r,a,o=1,s=!1,n=!1,c=t,l=0,d=!1,p=e.input.charCodeAt(e.position);if(124===p)r=!1;else{if(62!==p)return!1;r=!0}for(e.kind="scalar",e.result="";0!==p;)if(p=e.input.charCodeAt(++e.position),43===p||45===p)1===o?o=43===p?3:2:E(e,"repeat of a chomping mode identifier");else{if(!((a=w(p))>=0))break;0===a?E(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):n?E(e,"repeat of an indentation width identifier"):(c=t+a-1,n=!0)}if(f(p)){do{p=e.input.charCodeAt(++e.position)}while(f(p));if(35===p)do{p=e.input.charCodeAt(++e.position)}while(!m(p)&&0!==p)}for(;0!==p;){for(M(e),e.lineIndent=0,p=e.input.charCodeAt(e.position);(!n||e.lineIndent<c)&&32===p;)e.lineIndent++,p=e.input.charCodeAt(++e.position);if(!n&&e.lineIndent>c&&(c=e.lineIndent),m(p)){l++;continue}if(n||0!==c||E(e,"missing indentation for block scalar"),e.lineIndent<c){3===o?e.result+=i.repeat("\n",s?1+l:l):1===o&&s&&(e.result+="\n");break}r?f(p)?(d=!0,e.result+=i.repeat("\n",s?1+l:l)):d?(d=!1,e.result+=i.repeat("\n",l+1)):0===l?s&&(e.result+=" "):e.result+=i.repeat("\n",l):e.result+=i.repeat("\n",s?1+l:l),s=!0,n=!0,l=0;const t=e.position;for(;!m(p)&&0!==p;)p=e.input.charCodeAt(++e.position);F(e,t,e.position,!1)}return!0}(e,d)||function(e,t){let i,r,a=e.input.charCodeAt(e.position);if(39!==a)return!1;for(e.kind="scalar",e.result="",e.position++,i=r=e.position;0!==(a=e.input.charCodeAt(e.position));)if(39===a){if(F(e,i,e.position,!0),a=e.input.charCodeAt(++e.position),39!==a)return!0;i=e.position,e.position++,r=e.position}else m(a)?(F(e,i,r,!0),B(e,N(e,!1,t)),i=r=e.position):e.position===e.lineStart&&Y(e)?E(e,"unexpected end of the document within a single quoted scalar"):(e.position++,f(a)||(r=e.position));E(e,"unexpected end of the stream within a single quoted scalar")}(e,d)||function(e,t){let i,r,a,o=e.input.charCodeAt(e.position);if(34!==o)return!1;for(e.kind="scalar",e.result="",e.position++,i=r=e.position;0!==(o=e.input.charCodeAt(e.position));){if(34===o)return F(e,i,e.position,!0),e.position++,!0;if(92===o){if(F(e,i,e.position,!0),o=e.input.charCodeAt(++e.position),m(o))N(e,!1,t);else if(o<256&&S[o])e.result+=z[o],e.position++;else if((a=x(o))>0){let t=a,i=0;for(;t>0;t--)o=e.input.charCodeAt(++e.position),(a=b(o))>=0?i=(i<<4)+a:E(e,"expected hexadecimal character");e.result+=k(i),e.position++}else E(e,"unknown escape sequence");i=r=e.position}else m(o)?(F(e,i,r,!0),B(e,N(e,!1,t)),i=r=e.position):e.position===e.lineStart&&Y(e)?E(e,"unexpected end of the document within a double quoted scalar"):(e.position++,f(o)||(r=e.position))}E(e,"unexpected end of the stream within a double quoted scalar")}(e,d)?_=!0:function(e){let t=e.input.charCodeAt(e.position);if(42!==t)return!1;t=e.input.charCodeAt(++e.position);const i=e.position;for(;0!==t&&!y(t)&&!v(t);)t=e.input.charCodeAt(++e.position);e.position===i&&E(e,"name of an alias node must contain at least one character");const r=e.input.slice(i,e.position);return s.call(e.anchorMap,r)||E(e,'unidentified alias "'+r+'"'),e.result=e.anchorMap[r],N(e,!0,-1),!0}(e)?(_=!0,null===e.tag&&null===e.anchor||E(e,"alias node should not have any properties")):function(e,t,i){let r,a,o,s,n,c;const l=e.kind,d=e.result;let p=e.input.charCodeAt(e.position);if(y(p)||v(p)||35===p||38===p||42===p||33===p||124===p||62===p||39===p||34===p||37===p||64===p||96===p)return!1;if(63===p||45===p){const t=e.input.charCodeAt(e.position+1);if(y(t)||i&&v(t))return!1}for(e.kind="scalar",e.result="",r=a=e.position,o=!1;0!==p;){if(58===p){const t=e.input.charCodeAt(e.position+1);if(y(t)||i&&v(t))break}else if(35===p){if(y(e.input.charCodeAt(e.position-1)))break}else{if(e.position===e.lineStart&&Y(e)||i&&v(p))break;if(m(p)){if(s=e.line,n=e.lineStart,c=e.lineIndent,N(e,!1,-1),e.lineIndent>=t){o=!0,p=e.input.charCodeAt(e.position);continue}e.position=a,e.line=s,e.lineStart=n,e.lineIndent=c;break}}o&&(F(e,r,a,!1),B(e,e.line-s),r=a=e.position,o=!1),f(p)||(a=e.position+1),p=e.input.charCodeAt(++e.position)}return F(e,r,a,!1),!!e.result||(e.kind=l,e.result=d,!1)}(e,d,1===r)&&(_=!0,null===e.tag&&(e.tag="?")),null!==e.anchor&&q(e,e.anchor,e.result)}else 0===h&&(_=c&&K(e,p));if(null===e.tag)null!==e.anchor&&q(e,e.anchor,e.result);else if("?"===e.tag){null!==e.result&&"scalar"!==e.kind&&E(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"');for(let t=0,i=e.implicitTypes.length;t<i;t+=1)if(l=e.implicitTypes[t],l.resolve(e.result)){e.result=l.construct(e.result),e.tag=l.tag,null!==e.anchor&&q(e,e.anchor,e.result);break}}else if("!"!==e.tag){if(s.call(e.typeMap[e.kind||"fallback"],e.tag))l=e.typeMap[e.kind||"fallback"][e.tag];else{l=null;const t=e.typeMap.multi[e.kind||"fallback"];for(let i=0,r=t.length;i<r;i+=1)if(e.tag.slice(0,t[i].tag.length)===t[i].tag){l=t[i];break}}l||E(e,"unknown tag !<"+e.tag+">"),null!==e.result&&l.kind!==e.kind&&E(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+l.kind+'", not "'+e.kind+'"'),l.resolve(e.result,e.tag)?(e.result=l.construct(e.result,e.tag),null!==e.anchor&&q(e,e.anchor,e.result)):E(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return null!==e.listener&&e.listener("close",e),e.depth-=1,null!==e.tag||null!==e.anchor||_}function G(e){const t=e.position;let i,r=!1;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);0!==(i=e.input.charCodeAt(e.position))&&(N(e,!0,-1),i=e.input.charCodeAt(e.position),!(e.lineIndent>0||37!==i));){r=!0,i=e.input.charCodeAt(++e.position);let t=e.position;for(;0!==i&&!y(i);)i=e.input.charCodeAt(++e.position);const a=e.input.slice(t,e.position),o=[];for(a.length<1&&E(e,"directive name must not be less than one character in length");0!==i;){for(;f(i);)i=e.input.charCodeAt(++e.position);if(35===i){do{i=e.input.charCodeAt(++e.position)}while(0!==i&&!m(i));break}if(m(i))break;for(t=e.position;0!==i&&!y(i);)i=e.input.charCodeAt(++e.position);o.push(e.input.slice(t,e.position))}0!==i&&M(e),s.call(P,a)?P[a](e,a,o):I(e,'unknown document directive "'+a+'"')}N(e,!0,-1),0===e.lineIndent&&45===e.input.charCodeAt(e.position)&&45===e.input.charCodeAt(e.position+1)&&45===e.input.charCodeAt(e.position+2)?(e.position+=3,N(e,!0,-1)):r&&E(e,"directives end mark is expected"),H(e,e.lineIndent-1,4,!1,!0),N(e,!0,-1),e.checkLineBreaks&&c.test(e.input.slice(t,e.position))&&I(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&Y(e)?46===e.input.charCodeAt(e.position)&&(e.position+=3,N(e,!0,-1)):e.position<e.length-1&&E(e,"end of the stream or a document separator is expected")}function Z(e,t){t=t||{},0!==(e=String(e)).length&&(10!==e.charCodeAt(e.length-1)&&13!==e.charCodeAt(e.length-1)&&(e+="\n"),65279===e.charCodeAt(0)&&(e=e.slice(1)));const i=new A(e,t),r=e.indexOf("\0");for(-1!==r&&(i.position=r,E(i,"null byte is not allowed in input")),i.input+="\0";32===i.input.charCodeAt(i.position);)i.lineIndent+=1,i.position+=1;for(;i.position<i.length-1;)G(i);return i.documents}t.exports.loadAll=function(e,t,i){null!==t&&"object"==typeof t&&void 0===i&&(i=t,t=null);const r=Z(e,i);if("function"!=typeof t)return r;for(let e=0,i=r.length;e<i;e+=1)t(r[e])},t.exports.load=function(e,t){const i=Z(e,t);if(0!==i.length){if(1===i.length)return i[0];throw new r("expected a single document in the stream, but found more")}}}),j=l((e,t)=>{var i=p(),r=h(),a=L(),o=Object.prototype.toString,s=Object.prototype.hasOwnProperty,n=65279,c={0:"\\0",7:"\\a",8:"\\b",9:"\\t",10:"\\n",11:"\\v",12:"\\f",13:"\\r",27:"\\e",34:'\\"',92:"\\\\",133:"\\N",160:"\\_",8232:"\\L",8233:"\\P"},l=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],d=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function u(e){let t,a;const o=e.toString(16).toUpperCase();if(e<=255)t="x",a=2;else if(e<=65535)t="u",a=4;else{if(!(e<=4294967295))throw new r("code point within a string may not be greater than 0xFFFFFFFF");t="U",a=8}return"\\"+t+i.repeat("0",a-o.length)+o}function _(e){this.schema=e.schema||a,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=i.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=function(e,t){if(null===t)return{};const i={},r=Object.keys(t);for(let a=0,o=r.length;a<o;a+=1){let o=r[a],n=String(t[o]);"!!"===o.slice(0,2)&&(o="tag:yaml.org,2002:"+o.slice(2));const c=e.compiledTypeMap.fallback[o];c&&s.call(c.styleAliases,n)&&(n=c.styleAliases[n]),i[o]=n}return i}(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType='"'===e.quotingType?2:1,this.forceQuotes=e.forceQuotes||!1,this.replacer="function"==typeof e.replacer?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function g(e,t){const r=i.repeat(" ",t);let a=0,o="";const s=e.length;for(;a<s;){let t;const i=e.indexOf("\n",a);-1===i?(t=e.slice(a),a=s):(t=e.slice(a,i+1),a=i+1),t.length&&"\n"!==t&&(o+=r),o+=t}return o}function m(e,t){return"\n"+i.repeat(" ",e.indent*t)}function f(e){return 32===e||9===e}function y(e){return e>=32&&e<=126||e>=161&&e<=55295&&8232!==e&&8233!==e||e>=57344&&e<=65533&&e!==n||e>=65536&&e<=1114111}function v(e){return y(e)&&e!==n&&13!==e&&10!==e}function b(e,t,i){const r=v(e),a=r&&!f(e);return(i?r:r&&44!==e&&91!==e&&93!==e&&123!==e&&125!==e)&&35!==e&&!(58===t&&!a)||v(t)&&!f(t)&&35===e||58===t&&a}function x(e,t){const i=e.charCodeAt(t);let r;return i>=55296&&i<=56319&&t+1<e.length&&(r=e.charCodeAt(t+1),r>=56320&&r<=57343)?1024*(i-55296)+r-56320+65536:i}function w(e){return/^\n* /.test(e)}function C(e,t,i,a,o){e.dump=function(){if(0===t.length)return 2===e.quotingType?'""':"''";if(!e.noCompatMode&&(-1!==l.indexOf(t)||d.test(t)))return 2===e.quotingType?'"'+t+'"':"'"+t+"'";const s=e.indent*Math.max(1,i),p=-1===e.lineWidth?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-s),h=a||e.flowLevel>-1&&i>=e.flowLevel;switch(function(e,t,i,r,a,o,s,c){let l,d=0,p=null,h=!1,u=!1;const _=-1!==r;let g=-1,m=y(v=x(e,0))&&v!==n&&!f(v)&&45!==v&&63!==v&&58!==v&&44!==v&&91!==v&&93!==v&&123!==v&&125!==v&&35!==v&&38!==v&&42!==v&&33!==v&&124!==v&&61!==v&&62!==v&&39!==v&&34!==v&&37!==v&&64!==v&&96!==v&&function(e){return!f(e)&&58!==e}(x(e,e.length-1));var v;if(t||s)for(l=0;l<e.length;d>=65536?l+=2:l++){if(d=x(e,l),!y(d))return 5;m=m&&b(d,p,c),p=d}else{for(l=0;l<e.length;d>=65536?l+=2:l++){if(d=x(e,l),10===d)h=!0,_&&(u=u||l-g-1>r&&" "!==e[g+1],g=l);else if(!y(d))return 5;m=m&&b(d,p,c),p=d}u=u||_&&l-g-1>r&&" "!==e[g+1]}return h||u?i>9&&w(e)?5:s?2===o?5:2:u?4:3:!m||s||a(e)?2===o?5:2:1}(t,h,e.indent,p,function(t){return function(e,t){for(let i=0,r=e.implicitTypes.length;i<r;i+=1)if(e.implicitTypes[i].resolve(t))return!0;return!1}(e,t)},e.quotingType,e.forceQuotes&&!a,o)){case 1:return t;case 2:return"'"+t.replace(/'/g,"''")+"'";case 3:return"|"+k(t,e.indent)+$(g(t,s));case 4:return">"+k(t,e.indent)+$(g(function(e,t){const i=/(\n+)([^\n]*)/g;let r,a,o=function(){let r=e.indexOf("\n");return r=-1!==r?r:e.length,i.lastIndex=r,S(e.slice(0,r),t)}(),s="\n"===e[0]||" "===e[0];for(;a=i.exec(e);){const e=a[1],i=a[2];r=" "===i[0],o+=e+(s||r||""===i?"":"\n")+S(i,t),s=r}return o}(t,p),s));case 5:return'"'+function(e){let t="",i=0;for(let r=0;r<e.length;i>=65536?r+=2:r++){i=x(e,r);const a=c[i];!a&&y(i)?(t+=e[r],i>=65536&&(t+=e[r+1])):t+=a||u(i)}return t}(t)+'"';default:throw new r("impossible error: invalid scalar style")}}()}function k(e,t){const i=w(e)?String(t):"",r="\n"===e[e.length-1];return i+(!r||"\n"!==e[e.length-2]&&"\n"!==e?r?"":"-":"+")+"\n"}function $(e){return"\n"===e[e.length-1]?e.slice(0,-1):e}function S(e,t){if(""===e||" "===e[0])return e;const i=/ [^ ]/g;let r,a,o=0,s=0,n=0,c="";for(;r=i.exec(e);)n=r.index,n-o>t&&(a=s>o?s:n,c+="\n"+e.slice(o,a),o=a+1),s=n;return c+="\n",e.length-o>t&&s>o?c+=e.slice(o,s)+"\n"+e.slice(s+1):c+=e.slice(o),c.slice(1)}function z(e,t,i,r){let a="";const o=e.tag;for(let o=0,s=i.length;o<s;o+=1){let s=i[o];e.replacer&&(s=e.replacer.call(i,String(o),s)),(O(e,t+1,s,!0,!0,!1,!0)||void 0===s&&O(e,t+1,null,!0,!0,!1,!0))&&(r&&""===a||(a+=m(e,t)),e.dump&&10===e.dump.charCodeAt(0)?a+="-":a+="- ",a+=e.dump)}e.tag=o,e.dump=a||"[]"}function A(e,t,i){const a=i?e.explicitTypes:e.implicitTypes;for(let n=0,c=a.length;n<c;n+=1){const c=a[n];if((c.instanceOf||c.predicate)&&(!c.instanceOf||"object"==typeof t&&t instanceof c.instanceOf)&&(!c.predicate||c.predicate(t))){if(i?c.multi&&c.representName?e.tag=c.representName(t):e.tag=c.tag:e.tag="?",c.represent){const i=e.styleMap[c.tag]||c.defaultStyle;let a;if("[object Function]"===o.call(c.represent))a=c.represent(t,i);else{if(!s.call(c.represent,i))throw new r("!<"+c.tag+'> tag resolver accepts not "'+i+'" style');a=c.represent[i](t,i)}e.dump=a}return!0}}return!1}function O(e,t,i,a,s,n,c){e.tag=null,e.dump=i,A(e,i,!1)||A(e,i,!0);const l=o.call(e.dump),d=a;a&&(a=e.flowLevel<0||e.flowLevel>t);const p="[object Object]"===l||"[object Array]"===l;let h,u;if(p&&(h=e.duplicates.indexOf(i),u=-1!==h),(null!==e.tag&&"?"!==e.tag||u||2!==e.indent&&t>0)&&(s=!1),u&&e.usedDuplicates[h])e.dump="*ref_"+h;else{if(p&&u&&!e.usedDuplicates[h]&&(e.usedDuplicates[h]=!0),"[object Object]"===l)a&&0!==Object.keys(e.dump).length?(function(e,t,i,a){let o="";const s=e.tag,n=Object.keys(i);if(!0===e.sortKeys)n.sort();else if("function"==typeof e.sortKeys)n.sort(e.sortKeys);else if(e.sortKeys)throw new r("sortKeys must be a boolean or a function");for(let r=0,s=n.length;r<s;r+=1){let s="";a&&""===o||(s+=m(e,t));const c=n[r];let l=i[c];if(e.replacer&&(l=e.replacer.call(i,c,l)),!O(e,t+1,c,!0,!0,!0))continue;const d=null!==e.tag&&"?"!==e.tag||e.dump&&e.dump.length>1024;d&&(e.dump&&10===e.dump.charCodeAt(0)?s+="?":s+="? "),s+=e.dump,d&&(s+=m(e,t)),O(e,t+1,l,!0,d)&&(e.dump&&10===e.dump.charCodeAt(0)?s+=":":s+=": ",s+=e.dump,o+=s)}e.tag=s,e.dump=o||"{}"}(e,t,e.dump,s),u&&(e.dump="&ref_"+h+e.dump)):(function(e,t,i){let r="";const a=e.tag,o=Object.keys(i);for(let a=0,s=o.length;a<s;a+=1){let s="";""!==r&&(s+=", "),e.condenseFlow&&(s+='"');const n=o[a];let c=i[n];e.replacer&&(c=e.replacer.call(i,n,c)),O(e,t,n,!1,!1)&&(e.dump.length>1024&&(s+="? "),s+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),O(e,t,c,!1,!1)&&(s+=e.dump,r+=s))}e.tag=a,e.dump="{"+r+"}"}(e,t,e.dump),u&&(e.dump="&ref_"+h+" "+e.dump));else if("[object Array]"===l)a&&0!==e.dump.length?(e.noArrayIndent&&!c&&t>0?z(e,t-1,e.dump,s):z(e,t,e.dump,s),u&&(e.dump="&ref_"+h+e.dump)):(function(e,t,i){let r="";const a=e.tag;for(let a=0,o=i.length;a<o;a+=1){let o=i[a];e.replacer&&(o=e.replacer.call(i,String(a),o)),(O(e,t,o,!1,!1)||void 0===o&&O(e,t,null,!1,!1))&&(""!==r&&(r+=","+(e.condenseFlow?"":" ")),r+=e.dump)}e.tag=a,e.dump="["+r+"]"}(e,t,e.dump),u&&(e.dump="&ref_"+h+" "+e.dump));else{if("[object String]"!==l){if("[object Undefined]"===l)return!1;if(e.skipInvalid)return!1;throw new r("unacceptable kind of an object to dump "+l)}"?"!==e.tag&&C(e,e.dump,t,n,d)}if(null!==e.tag&&"?"!==e.tag){let t=encodeURI("!"===e.tag[0]?e.tag.slice(1):e.tag).replace(/!/g,"%21");t="!"===e.tag[0]?"!"+t:"tag:yaml.org,2002:"===t.slice(0,18)?"!!"+t.slice(18):"!<"+t+">",e.dump=t+" "+e.dump}}return!0}function E(e,t){const i=[],r=[];I(e,i,r);const a=r.length;for(let e=0;e<a;e+=1)t.duplicates.push(i[r[e]]);t.usedDuplicates=new Array(a)}function I(e,t,i){if(null!==e&&"object"==typeof e){const r=t.indexOf(e);if(-1!==r)-1===i.indexOf(r)&&i.push(r);else if(t.push(e),Array.isArray(e))for(let r=0,a=e.length;r<a;r+=1)I(e[r],t,i);else{const r=Object.keys(e);for(let a=0,o=r.length;a<o;a+=1)I(e[r[a]],t,i)}}}t.exports.dump=function(e,t){const i=new _(t=t||{});i.noRefs||E(e,i);let r=e;return i.replacer&&(r=i.replacer.call({"":r},"",r)),O(i,0,r,!0,!0)?i.dump+"\n":""}}),D=d(l((e,t)=>{var i=q(),r=j();function a(e,t){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+t+" instead, which is now safe by default.")}}t.exports.Type=_(),t.exports.Schema=g(),t.exports.FAILSAFE_SCHEMA=v(),t.exports.JSON_SCHEMA=k(),t.exports.CORE_SCHEMA=$(),t.exports.DEFAULT_SCHEMA=L(),t.exports.load=i.load,t.exports.loadAll=i.loadAll,t.exports.dump=r.dump,t.exports.YAMLException=h(),t.exports.types={binary:A(),float:C(),map:y(),null:b(),pairs:E(),set:I(),timestamp:S(),bool:x(),int:w(),merge:z(),omap:O(),seq:f(),str:m()},t.exports.safeLoad=a("safeLoad","load"),t.exports.safeLoadAll=a("safeLoadAll","loadAll"),t.exports.safeDump=a("safeDump","dump")})(),1),{Type:P,Schema:F,FAILSAFE_SCHEMA:T,JSON_SCHEMA:W,CORE_SCHEMA:M,DEFAULT_SCHEMA:N,load:Y,loadAll:B,dump:K,YAMLException:R,types:V,safeLoad:U,safeLoadAll:H,safeDump:G}=D.default,Z=D.default}}]);