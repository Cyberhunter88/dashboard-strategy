...
// ====================================================================
// Opt-in view (show_cctv_view): one block per camera DEVICE with
...
export async function buildCctvSections(
  ...
  if (dashboardConfig.show_camera_events === true || dashboardConfig.cctv_show_activity === true) {
...
defineViewStrategy('ll-strategy-dashboard-strategy-view-cctv', generateCctvView);
